		...
		<div class="row">
			...
			<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
				...
				<div class="row">
					...
					<div class="col-lg-6 mb-3">
						...
						<div class="menu-item p-0 m-0">
							<!--begin:Menu link-->
							<NuxtLink exact-active-class="active" to="/" class="menu-link">
					...
					<div class="col-lg-6 mb-3">
						...
						<div class="menu-item p-0 m-0">
							<!--begin:Menu link-->
							<NuxtLink exact-active-class="active" to="/dashboards/ecommerce" class="menu-link">
								<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
					...
					<div class="col-lg-6 mb-3">
						...
						<div class="menu-item p-0 m-0">
							<!--begin:Menu link-->
							<NuxtLink exact-active-class="active" to="/dashboards/projects" class="menu-link">
								<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
					...
					<div class="col-lg-6 mb-3">
						...
						<div class="menu-item p-0 m-0">
							<!--begin:Menu link-->
							<NuxtLink exact-active-class="active" to="/dashboards/online-courses" class="menu-link">
								<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
					...
					<div class="col-lg-6 mb-3">
						...
						<div class="menu-item p-0 m-0">
							<!--begin:Menu link-->
							<NuxtLink exact-active-class="active" to="/dashboards/marketing" class="menu-link">
								<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
					...
					<div class="col-lg-6 mb-3">
						...
						<div class="menu-item p-0 m-0">
							<!--begin:Menu link-->
							<NuxtLink exact-active-class="active" to="/dashboards/bidding" class="menu-link">
								<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
					...
					<div class="col-lg-6 mb-3">
						...
						<div class="menu-item p-0 m-0">
							<!--begin:Menu link-->
							<NuxtLink exact-active-class="active" to="/dashboards/pos" class="menu-link">
								<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
					...
					<div class="col-lg-6 mb-3">
						...
						<div class="menu-item p-0 m-0">
							<!--begin:Menu link-->
							<NuxtLink exact-active-class="active" to="/dashboards/call-center" class="menu-link">
								<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
				...
				<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
					...
					<NuxtLink exact-active-class="active" to="/landing" class="btn btn-sm btn-primary fw-bold">Explore</NuxtLink>
				</div>
				<!--end:Landing-->
			</div>
			<!--end:Col-->
			...
			<div class="menu-more bg-light col-lg-4 py-3 px-3 py-lg-6 px-lg-6 rounded-end">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/logistics" class="menu-link py-2">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/website-analytics" class="menu-link py-2">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/finance-performance" class="menu-link py-2">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/store-analytics" class="menu-link py-2">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/social" class="menu-link py-2">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/delivery" class="menu-link py-2">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/crypto" class="menu-link py-2">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/school" class="menu-link py-2">
				...
				<div class="menu-item p-0 m-0">
					<!--begin:Menu link-->
					<NuxtLink exact-active-class="active" to="/dashboards/podcast" class="menu-link py-2">
