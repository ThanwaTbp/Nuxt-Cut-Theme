				...
				<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="scroll-y mh-325px my-5 px-8">
										...
										<div class="d-flex flex-stack py-4">
											...
											<div class="d-flex align-items-center">
												...
												<!--begin::Title-->
												<div class="mb-0 me-2">
													<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Icon </a>
					...
					<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
						...
						<div
								...
								<a href="#" class="menu-link px-5">
									<span class="menu-title position-relative">Language
										<span
											...
											<img class="w-15px h-15px rounded-1 ms-2" src="/media/flags/united-states.svg"
												alt="" /></span></span>
								</a>
								<!--begin::Menu sub-->
								<div class="menu-sub menu-sub-dropdown w-175px py-4">
							...
							<!--begin::Menu item-->
							<div class="menu-item px-5">
								<NuxtLink to="/auth/sign-in" class="menu-link px-5">Sign
									Out</NuxtLink>
							</div>
							<!--end::Menu item-->
						</div>
	...
	<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
		...
		<div class="card shadow-none border-0 rounded-0">
						...
						<div class="timeline-item">
							...
							<div class="timeline-content mb-10 mt-n2">
								...
								<div class="overflow-auto pe-3">
									<!--begin::Title-->
									<div class="fs-5 fw-semibold mb-2">Invitation for crafting engaging designs that speak human workshop
									</div>
									<!--end::Title-->
									<!--begin::Description-->
									<div class="d-flex align-items-center mt-1 fs-6">
							...
							<div class="timeline-content mb-10 mt-n1">
								...
								<div class="pe-3 mb-5">
									...
									<div class="fs-5 fw-semibold mb-2">New case
										<a href="#" class="text-primary fw-bold me-1">#67890</a>is assigned to you in Multi-platform Database
										Design project
									</div>
									<!--end::Title-->
									<!--begin::Description-->
									...
									<div
										...
										<div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
											...
											<div class="mb-3 mb-md-0 fw-semibold">
												...
												<div class="fs-6 text-gray-700 pe-7">Login into Admin Dashboard to make sure the data integrity is
													OK</div>
											</div>
											<!--end::Content-->
											<!--begin::Action-->
							...
							<div class="timeline-content mt-n1">
								...
								<div class="pe-3 mb-5">
									...
									<div class="fs-5 fw-semibold mb-2">New order
										<a href="#" class="text-primary fw-bold me-1">#67890</a>is placed for Workshow Planning & Budget
										Estimation
									</div>
									<!--end::Title-->
									<!--begin::Description-->
			...
			<div class="card-footer py-5 text-center" id="kt_activities_footer">
				<a href="../../demo6/dist/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View All
					Activities
					<!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
