			...
			<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
				...
				<div class="d-flex flex-center flex-column flex-lg-row-fluid">
					...
					<div class="w-lg-500px p-10">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form"
							data-kt-redirect-url="../../demo6/dist/authentication/layouts/corporate/sign-in" action="#">
							<!--begin::Heading-->
							...
							<div class="text-gray-500 text-center fw-semibold fs-6">Already have an Account?
								<a href="../../demo6/dist/authentication/layouts/corporate/sign-in"
				...
				<div class="d-flex flex-center flex-wrap px-5">
					...
					<div class="d-flex fw-semibold text-primary fs-base">
						<NuxtLink to="/auth/team" class="px-5" target="_blank">Terms</NuxtLink>
						<NuxtLink to="/auth/pricing/column" class="px-5" target="_blank">Plans</NuxtLink>
						<NuxtLink to="/auth/contact" class="px-5" target="_blank">Contact Us</NuxtLink>
					</div>
					<!--end::Links-->
				</div>
				<!--end::Footer-->
