	...
	<div class="d-flex flex-column flex-lg-row-fluid p-10">
		...
		<div class="d-flex flex-center flex-column flex-lg-row-fluid">
			...
			<div class="w-lg-500px p-10">
				<!--begin::Form-->
				<form class="form w-100 mb-13" novalidate="novalidate" data-kt-redirect-url="../../demo6/dist/index"
					id="kt_sing_in_two_steps_form">
					<!--begin::Icon-->
					<div class="text-center mb-10">
						<img alt="Logo" class="mh-125px" src="/media/svg/misc/smartphone-2.svg" />
					</div>
					<!--end::Icon-->
					<!--begin::Heading-->
					<div class="text-center mb-10">
		...
		<div class="d-flex flex-center flex-wrap px-5">
			...
			<div class="d-flex fw-semibold text-primary fs-base">
				<NuxtLink to="/pages/team" class="px-5" target="_blank">Terms</NuxtLink>
				<NuxtLink to="/pages/pricing/column" class="px-5" target="_blank">Plans</NuxtLink>
				<NuxtLink to="/pages/contact" class="px-5" target="_blank">Contact Us</NuxtLink>
			</div>
			<!--end::Links-->
		</div>
		<!--end::Footer-->
