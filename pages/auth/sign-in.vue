			...
			<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
							...
							<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
								...
								<NuxtLink to="/auth/reset-password"
									class="link-primary">Forgot Password ?</NuxtLink>
								<!--end::Link-->
							</div>
							<!--end::Wrapper-->
							<!--begin::Submit button-->
							...
							<div class="text-gray-500 text-center fw-semibold fs-6">Not a Member yet?
								<NuxtLink to="/auth/sign-up" class="link-primary">Sign up</NuxtLink>
							</div>
							<!--end::Sign up-->
						</form>
						<!--end::Form-->
				...
				<div class="d-flex flex-center flex-wrap px-5">
					...
					<div class="d-flex fw-semibold text-primary fs-base">
						<a href="../../demo6/dist/pages/team" class="px-5" target="_blank">Terms</a>
						<a href="../../demo6/dist/pages/pricing/column" class="px-5" target="_blank">Plans</a>
						<a href="../../demo6/dist/pages/contact" class="px-5" target="_blank">Contact Us</a>
					</div>
					<!--end::Links-->
				</div>
				<!--end::Footer-->
