			...
			<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
				...
				<div class="col-xl-3">
					...
					<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
						style="background-color: #F1416C;background-image:url('/media/svg/shapes/wave-bg-red.svg')">
						<!--begin::Header-->
				...
				<div class="col-xl-3">
					<!--begin::Card widget 3-->
					<div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
						style="background-color: #7239EA;background-image:url('/media/svg/shapes/wave-bg-purple.svg')">
						<!--begin::Header-->
						<div class="card-header pt-5 mb-3">
							<!--begin::Icon-->
							<div class="d-flex flex-center rounded-circle h-80px w-80px"
					...
					<div class="card h-lg-100" style="background: linear-gradient(112.14deg, #FF8A00 0%, #E96922 100%)">
						...
						<div class="card-body">
							...
							<div class="row align-items-center">
										...
										<div class="mb-7">
											...
											<div class="d-flex align-items-center flex-wrap d-grid gap-2">
												...
												<div class="d-flex align-items-center">
													...
													<!--begin::Info-->
													<div class="m-0">
														<a href="../../demo6/dist/apps/user-management/users/list.html"
								...
								<div class="col-sm-5">
									<!--begin::Illustration-->
									<img src="/media/svg/illustrations/easy/7.svg" class="h-200px h-lg-250px my-n6" alt="" />
									<!--end::Illustration-->
								</div>
								<!--begin::Col-->
							</div>
