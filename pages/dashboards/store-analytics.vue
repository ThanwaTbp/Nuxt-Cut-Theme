					...
					<div class="card h-md-100">
						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="text-center mb-1">
								<!--begin::Link-->
								<a class="btn btn-sm btn-primary me-2" href="../../demo6/dist/apps/ecommerce/customers/listing.html">Try
									now</a>
								<!--end::Link-->
								<!--begin::Link-->
				...
				<div class="col-xl-4 mb-5 mb-xl-10">
					...
					<div class="card card-flush h-md-100">
						...
						<div class="card-header pt-7">
							...
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<a href="../../demo6/dist/apps/ecommerce/catalog/categories.html" class="btn btn-sm btn-light">View
									All</a>
							</div>
							<!--end::Toolbar-->
						</div>
							...
							<div class="table-responsive">
								...
								<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
									...
									<tbody>
										<tr>
											<td>
												<img src="/media/stock/ecommerce/210.gif" class="w-50px" alt="" />
											</td>
											<td class="ps-0">
										...
										<tr>
											<td>
												<img src="/media/stock/ecommerce/215.gif" class="w-50px" alt="" />
											</td>
											<td class="ps-0">
												<a href="../../demo6/dist/apps/ecommerce/sales/details.html"
										...
										<tr>
											<td>
												<img src="/media/stock/ecommerce/209.gif" class="w-50px" alt="" />
											</td>
											<td class="ps-0">
												<a href="../../demo6/dist/apps/ecommerce/sales/details.html"
										...
										<tr>
											<td>
												<img src="/media/stock/ecommerce/214.gif" class="w-50px" alt="" />
											</td>
											<td class="ps-0">
												<a href="../../demo6/dist/apps/ecommerce/sales/details.html"
													class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Yellow Stone</a>
												<span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-2347</span>
											</td>
											<td>
												<span class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">$72.00</span>
				...
				<div class="col-xl-4 mb-xl-10">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body pt-0">
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/flags/united-states.svg" class="me-4 w-25px" style="border-radius: 4px" alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/flags/brazil.svg" class="me-4 w-25px" style="border-radius: 4px" alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
									<!--begin::Content-->
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/flags/turkey.svg" class="me-4 w-25px" style="border-radius: 4px" alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
									<!--begin::Content-->
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/flags/france.svg" class="me-4 w-25px" style="border-radius: 4px" alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
									<!--begin::Content-->
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/flags/india.svg" class="me-4 w-25px" style="border-radius: 4px" alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
									<!--begin::Content-->
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/flags/sweden.svg" class="me-4 w-25px" style="border-radius: 4px" alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
									<!--begin::Content-->
				...
				<div class="col-xl-4 mb-xl-10">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body card-body d-flex justify-content-between flex-column pt-3">
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/svg/brand-logos/dribbble-icon-1.svg" class="me-4 w-30px" style="border-radius: 4px"
									alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/svg/brand-logos/linkedin-1.svg" class="me-4 w-30px" style="border-radius: 4px"
									alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/svg/brand-logos/slack-icon.svg" class="me-4 w-30px" style="border-radius: 4px"
									alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/svg/brand-logos/youtube-3.svg" class="me-4 w-30px" style="border-radius: 4px"
									alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/svg/brand-logos/instagram-2-1.svg" class="me-4 w-30px" style="border-radius: 4px"
									alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
							...
							<div class="d-flex flex-stack">
								<!--begin::Flag-->
								<img src="/media/svg/brand-logos/facebook-3.svg" class="me-4 w-30px" style="border-radius: 4px"
									alt="" />
								<!--end::Flag-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
