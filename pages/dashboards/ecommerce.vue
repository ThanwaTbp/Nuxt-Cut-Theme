							...
							<ul class="nav nav-pills nav-pills-custom mb-3">
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="" src="/media/svg/products-categories/t-shirt.svg" class="" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="" src="/media/svg/products-categories/gaming.svg" class="" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="" src="/media/svg/products-categories/watch.svg" class="" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="" src="/media/svg/products-categories/gloves.svg" class="nav-icon" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
								...
								<li class="nav-item mb-3">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="" src="/media/svg/products-categories/shoes.svg" class="nav-icon" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
									...
									<div class="table-responsive">
										...
										<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
											...
											<tbody>
												<tr>
													<td>
														<img src="/media/stock/ecommerce/210.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/215.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/209.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
									...
									<div class="table-responsive">
										...
										<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
											...
											<tbody>
												<tr>
													<td>
														<img src="/media/stock/ecommerce/197.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/178.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/22.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
										...
										<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
											...
											<tbody>
												<tr>
													...
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/24.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/71.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
									...
									<div class="table-responsive">
										...
										<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
											...
											<tbody>
												<tr>
													<td>
														<img src="/media/stock/ecommerce/41.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
														<span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
													</td>
													<td>
														<span class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">x1</span>
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/63.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/59.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
															class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
									...
									<div class="table-responsive">
										...
										<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
											...
											<tbody>
												<tr>
													<td>
														<img src="/media/stock/ecommerce/10.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/96.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
												...
												<tr>
													<td>
														<img src="/media/stock/ecommerce/13.gif" class="w-50px ms-n1" alt="" />
													</td>
													<td class="ps-0">
														<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="mb-2">
								...
								<div class="py-10 text-center">
									<img src="/media/svg/illustrations/easy/2.svg" class="theme-light-show w-200px" alt="" />
									<img src="/media/svg/illustrations/easy/2-dark.svg" class="theme-dark-show w-200px" alt="" />
								</div>
								<!--end::Illustration-->
							</div>
							<!--end::Heading-->
							...
							<div class="text-center mb-1">
								<!--begin::Link-->
								<a class="btn btn-sm btn-primary me-2" href="../../demo6/dist/apps/ecommerce/sales/listing.html">View
									App</a>
								<!--end::Link-->
								<!--begin::Link-->
								<a class="btn btn-sm btn-light" href="../../demo6/dist/apps/ecommerce/catalog/add-product.html">New
									Product</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
										...
										<td colspan="2">
											<div class="d-flex align-items-center gap-3">
												<a href="#" class="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
													<img src="" data-kt-src-path="/media/stock/ecommerce/" alt=""
				...
				<div class="col-xl-4">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-header pt-7">
							...
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<a href="../../demo6/dist/apps/ecommerce/sales/details.html" class="btn btn-sm btn-light">Order
									Details</a>
							</div>
							<!--end::Toolbar-->
						</div>
							...
							<div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
								...
								<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
									...
									<div class="d-flex flex-stack mb-3">
										...
										<div class="me-3">
											<!--begin::Icon-->
											<img src="/media/stock/ecommerce/210.gif" class="w-50px ms-n1 me-1" alt="" />
											<!--end::Icon-->
											<!--begin::Title-->
											<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
								...
								<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
									...
									<div class="d-flex flex-stack mb-3">
										...
										<div class="me-3">
											<!--begin::Icon-->
											<img src="/media/stock/ecommerce/209.gif" class="w-50px ms-n1 me-1" alt="" />
											<!--end::Icon-->
											<!--begin::Title-->
											<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
								...
								<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
									...
									<div class="d-flex flex-stack mb-3">
										...
										<div class="me-3">
											<!--begin::Icon-->
											<img src="/media/stock/ecommerce/214.gif" class="w-50px ms-n1 me-1" alt="" />
											<!--end::Icon-->
											<!--begin::Title-->
											<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
								...
								<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
									...
									<div class="d-flex flex-stack mb-3">
										...
										<div class="me-3">
											<!--begin::Icon-->
											<img src="/media/stock/ecommerce/211.gif" class="w-50px ms-n1 me-1" alt="" />
											<!--end::Icon-->
											<!--begin::Title-->
											<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
												class="text-gray-800 text-hover-primary fw-bold">Elephant 1802</a>
								...
								<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
									...
									<div class="d-flex flex-stack mb-3">
										...
										<div class="me-3">
											<!--begin::Icon-->
											<img src="/media/stock/ecommerce/215.gif" class="w-50px ms-n1 me-1" alt="" />
											<!--end::Icon-->
											<!--begin::Title-->
											<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
												class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
								...
								<div class="border border-dashed border-gray-300 rounded px-7 py-3">
									...
									<div class="d-flex flex-stack mb-3">
										...
										<div class="me-3">
											<!--begin::Icon-->
											<img src="/media/stock/ecommerce/192.gif" class="w-50px ms-n1 me-1" alt="" />
											<!--end::Icon-->
											<!--begin::Title-->
											<a href="../../demo6/dist/apps/ecommerce/catalog/edit-product.html"
												class="text-gray-800 text-hover-primary fw-bold">Yellow Stone</a>
						...
						<div class="card-header pt-7">
							...
							<div class="card-toolbar">
								...
								<div class="d-flex flex-stack flex-wrap gap-4">
									...
									<!--end::Status-->
									<!--begin::Search-->
									<a href="../../demo6/dist/apps/ecommerce/catalog/products.html" class="btn btn-light btn-sm">View
										Stock</a>
									<!--end::Search-->
								</div>
								<!--begin::Filters-->
