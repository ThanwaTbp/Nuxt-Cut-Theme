							...
							<ul class="nav nav-pills nav-pills-custom mb-3">
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="" src="/media/svg/brand-logos/beats-electronics.svg" class="" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="Logo" src="/media/svg/brand-logos/amazon.svg" class="theme-light-show" />
											<img alt="Logo" src="/media/svg/brand-logos/amazon-dark.svg" class="theme-dark-show" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="" src="/media/svg/brand-logos/bp-2.svg" class="" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
								...
								<li class="nav-item mb-3 me-3 me-lg-6">
									...
									<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
										...
										<!--begin::Icon-->
										<div class="nav-icon">
											<img alt="" src="/media/svg/brand-logos/slack-icon.svg" class="nav-icon" />
										</div>
										<!--end::Icon-->
										<!--begin::Subtitle-->
								...
								<li class="nav-item mb-3">
									...
									<a class="nav-link d-flex flex-center overflow-hidden w-80px h-85px" data-bs-toggle="modal"
										data-bs-target="#kt_modal_create_campaign" href="#">
										<!--begin::Icon-->
										<div class="nav-icon">
									...
									<div class="table-responsive">
										...
										<table class="table align-middle gs-0 gy-4 my-0">
											...
											<tbody>
												<tr>
													<td>
														<a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Best Rated Headsets of
															2022</a>
													</td>
													<td class="text-end">
												...
												<tr>
													<td>
														<a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">2022 Spring Conference
															by Beats</a>
													</td>
													<td class="text-end">
														<span class="badge badge-light-success fs-7 fw-bold">Sent</span>
												...
												<tr>
													<td>
														<a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Best Headsets
															Giveaway</a>
													</td>
													<td class="text-end">
								...
								<div class="card-body d-flex justify-content-between flex-column pt-1 px-0 pb-0">
									...
									<div class="d-flex flex-wrap px-9 mb-5">
										...
										<div class="rounded min-w-125px py-3 px-4 my-1" style="border: 1px dashed rgba(255, 255, 255, 0.15)">
											<!--begin::Number-->
											<div class="d-flex align-items-center">
												<div class="text-white fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="120,000">0
												</div>
											</div>
											<!--end::Number-->
											<!--begin::Label-->
											...
											<div class="mb-10">
												...
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true"
														data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df2063a190"
					...
					<div class="card h-xl-100">
						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="text-center mb-1">
								<!--begin::Link-->
								<a class="btn btn-sm btn-primary me-2" data-bs-target="#kt_modal_new_card" data-bs-toggle="modal">Try
									now</a>
								<!--end::Link-->
								<!--begin::Link-->
								<a class="btn btn-sm btn-light" href="../../demo6/dist/pages/user-profile/followers.html">Learn more</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
						</div>
