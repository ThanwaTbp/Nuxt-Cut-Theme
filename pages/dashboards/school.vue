						...
						<div class="card-body d-flex flex-column pt-13 pb-14">
							...
							<div class="m-0">
								...
								<div
									...
									style="background-image:url('/media/svg/illustrations/easy/6.svg')"></div>
								<!--end::Illustration-->
							</div>
							<!--end::Heading-->
							<!--begin::Links-->
							<div class="text-center">
								...
								<a class="btn btn-sm bg-white btn-color-white bg-opacity-20"
									href="../../demo6/dist/pages/careers/list.html">Nurse</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
						</div>
											...
											<div class="d-flex border border-gray-300 border-dashed rounded p-6 mb-6">
												...
												<div class="d-flex align-items-center flex-grow-1 me-2 me-sm-5">
													...
													<div class="me-2">
														...
														<span class="text-gray-400 fw-bold d-block fs-7">Great, you always attending class. keep it
															up</span>
													</div>
													<!--end::Section-->
												</div>
						...
						<div class="card-header pt-5 mb-5">
							...
							<div class="card-toolbar">
								<div class="d-flex justify-content-end">
									...
									<a href="#kt_sliders_widget_3_slider" class="carousel-control-next position-relative me-1" role="button"
										data-bs-slide="next">
										...
										<table class="table align-middle gs-0 gy-4">
											...
											<tbody>
												<tr>
													...
													<td>
														<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Book p. 77-85, read &
												...
												<tr>
													...
													<td>
														<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Workbook p. 17, tasks
															1-6</a>
												...
												<tr>
													...
													<td>
														<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Learn paragraph p. 99,
															Exercise 1,2,3Scoping & Estimations</a>
												...
												<tr>
													...
													<td>
														<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Write essay 1000 words “WW2
															results”</a>
												...
												<tr>
													...
													<td>
														<a href="#" class="text-gray-800 text-hover-primary fw-bold fs-6">Internal conflicts in Philip
															Larkin poems, read p 380-515</a>
