			...
			<div class="row g-5 g-xl-10 mb-5 mb-xl-10">
				...
				<div class="col-xl-8">
					...
					<div class="card flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100"
						style="background-color:#020202;background-image:url('/media/stock/600x600/img-62.jpg')">
						<!--begin::Body-->
					...
					<div class="card card-flush h-xl-100" id="kt_player_widget_2">
						...
						<div class="card-body bg-black pt-0">
							...
							<div class="mx-auto mb-6 bgi-no-repeat bgi-size-contain bgi-position-center rounded-circle w-125px h-125px"
								style="background-image:url('/media/stock/600x600/img-59.jpg')"></div>
							<!--end::Image-->
							<!--begin::Section-->
						...
						<div class="card-footer bg-primary p-0 pb-9">
							<div class="mt-n10">
								...
								<div class="mb-5">
									...
									<!--end::Time-->
									<input type="range" class="form-range" data-kt-element="progress" min="0" max="100" value="0"
										step="0.01" />
								</div>
								<!--end::Progress-->
								<!--begin::Toolbar-->
				...
				<div class="col-xl-8">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-header pt-7">
							...
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<a href="../../demo6/dist/account/statements.html" class="btn btn-sm btn-light">History</a>
							</div>
							<!--end::Toolbar-->
						</div>
						<!--end::Header-->
									...
									<div class="m-0">
										...
										<div class="card-rounded position-relative mb-5">
											...
											<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
												style="background-image:url('/media/stock/600x600/img-61.jpg')"></div>
											<!--end::Img-->
											<!--begin::Play-->
								...
								<div class="col-sm-3 mb-3 mb-sm-0">
									...
									<div class="m-0">
										...
										<div class="card-rounded position-relative mb-5">
											<!--begin::Img-->
											<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
												style="background-image:url('/media/stock/600x600/img-60.jpg')"></div>
											<!--end::Img-->
											<!--begin::Play-->
											<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0"
												data-kt-element="list-play-button">
								...
								<div class="col-sm-3 mb-3 mb-sm-0">
									...
									<div class="m-0">
										...
										<div class="card-rounded position-relative mb-5">
											<!--begin::Img-->
											<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
												style="background-image:url('/media/stock/600x600/img-63.jpg')"></div>
											<!--end::Img-->
											<!--begin::Play-->
											<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0"
												data-kt-element="list-play-button">
								...
								<div class="col-sm-3 mb-3 mb-sm-0">
									...
									<div class="m-0">
										...
										<div class="card-rounded position-relative mb-5">
											<!--begin::Img-->
											<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
												style="background-image:url('/media/stock/600x600/img-56.jpg')"></div>
											<!--end::Img-->
											<!--begin::Play-->
											<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0"
												data-kt-element="list-play-button">
								...
								<div class="col-sm-3 mb-3 mb-sm-0">
									...
									<div class="m-0">
										...
										<div class="card-rounded position-relative mb-5">
											<!--begin::Img-->
											<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
												style="background-image:url('/media/stock/600x600/img-57.jpg')"></div>
											<!--end::Img-->
											<!--begin::Play-->
											<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0"
												data-kt-element="list-play-button">
								...
								<div class="col-sm-3 mb-3 mb-sm-0">
									...
									<div class="m-0">
										...
										<div class="card-rounded position-relative mb-5">
											<!--begin::Img-->
											<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
												style="background-image:url('/media/stock/600x600/img-58.jpg')"></div>
											<!--end::Img-->
											<!--begin::Play-->
											<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0"
												data-kt-element="list-play-button">
								...
								<div class="col-sm-3 mb-3 mb-sm-0">
									...
									<div class="m-0">
										...
										<div class="card-rounded position-relative mb-5">
											<!--begin::Img-->
											<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
												style="background-image:url('/media/stock/600x600/img-55.jpg')"></div>
											<!--end::Img-->
											<!--begin::Play-->
											<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0"
												data-kt-element="list-play-button">
								...
								<div class="col-sm-3">
									...
									<div class="m-0">
										...
										<div class="card-rounded position-relative mb-5">
											<!--begin::Img-->
											<div class="bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded"
												style="background-image:url('/media/stock/600x600/img-64.jpg')"></div>
											<!--end::Img-->
											<!--begin::Play-->
											<button class="btn btn-icon h-auto w-auto p-0 ms-4 mb-4 position-absolute bottom-0 right-0"
												data-kt-element="list-play-button">
						...
						<div class="card-body pt-6">
							...
							<div class="d-flex flex-stack">
								...
								<div class="symbol symbol-circle symbol-60px me-4">
									<img src="/media/avatars/300-28.jpg" class="" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
							...
							<div class="d-flex flex-stack">
								<!--begin::Symbol-->
								<div class="symbol symbol-circle symbol-60px me-4">
									<img src="/media/avatars/300-29.jpg" class="" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
							...
							<div class="d-flex flex-stack">
								<!--begin::Symbol-->
								<div class="symbol symbol-circle symbol-60px me-4">
									<img src="/media/avatars/300-27.jpg" class="" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
							...
							<div class="d-flex flex-stack">
								<!--begin::Symbol-->
								<div class="symbol symbol-circle symbol-60px me-4">
									<img src="/media/avatars/300-30.jpg" class="" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
							...
							<div class="row align-items-end h-100 gx-5 gx-xl-10">
								...
								<div class="col-md-4 mb-11 mb-md-0">
									...
									<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
										href="/media/stock/900x600/42.jpg">
										<!--begin::Image-->
										<div
											class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
											style="height: 266px;background-image:url('/media/stock/900x600/42.jpg"></div>
										<!--end::Image-->
										<!--begin::Action-->
								...
								<div class="col-md-4 mb-11 mb-md-0">
									<!--begin::Overlay-->
									<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
										href="/media/stock/900x600/40.jpg">
										<!--begin::Image-->
										<div
											class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
											style="height: 266px;background-image:url('/media/stock/900x600/40.jpg"></div>
										<!--end::Image-->
										<!--begin::Action-->
										<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
											<i class="bi bi-eye-fill fs-2x text-white"></i>
								...
								<div class="col-md-4">
									<!--begin::Overlay-->
									<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
										href="/media/stock/900x600/41.jpg">
										<!--begin::Image-->
										<div
											class="overlay-wrapper bgi-position-center bgi-no-repeat bgi-size-cover h-200px card-rounded mb-3"
											style="height: 266px;background-image:url('/media/stock/900x600/41.jpg"></div>
										<!--end::Image-->
										<!--begin::Action-->
										<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
											<i class="bi bi-eye-fill fs-2x text-white"></i>
						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="mb-2">
								...
								<div class="py-10 text-center">
									<img src="/media/svg/illustrations/easy/2.svg" class="theme-light-show h-125px" alt="" />
									<img src="/media/svg/illustrations/easy/2-dark.svg" class="theme-dark-show h-125px" alt="" />
								</div>
								<!--end::Illustration-->
							</div>
							<!--end::Heading-->
							...
							<div class="text-center mb-1">
								<!--begin::Link-->
								<a class="btn btn-sm btn-primary me-2" data-bs-target="#kt_modal_offer_a_deal" data-bs-toggle="modal">Try
									Now</a>
								<!--end::Link-->
								<!--begin::Link-->
								<a class="btn btn-sm btn-light" href="../../demo6/dist/account/billing.html">Learn More</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
						</div>
