				...
				<div class="col-xl-4 mb-xl-10">
					...
					<div class="card card-flush h-xl-100">
						...
						<div
							...
							style="background-image:url('/media/svg/shapes/top-green.png" data-theme="light')">
							<!--begin::Title-->
							<h3 class="card-title align-items-start flex-column text-white pt-15">
								...
								<div class="fs-4 text-white">
									...
									<span class="position-relative d-inline-block">
										<NuxtLink href="/pages/user-profile/projects"
											class="link-white opacity-75-hover fw-bold d-block mb-1">4 tasks</NuxtLink>
										<!--begin::Separator-->
										<span
				...
				<div class="col-xl-8 mb-5 mb-xl-10">
					...
					<div class="card border-transparent" data-theme="light" style="background-color: #1C325E;">
						...
						<div class="card-body d-flex ps-xl-15">
							...
							<!--begin::Wrapper-->
							<!--begin::Illustration-->
							<img src="/media/illustrations/sigma-1/17-dark.png"
						...
						<div class="card-body pt-5">
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Logo-->
									<img src="/media/svg/brand-logos/laravel-2.svg" class="me-4 w-30px" alt="" />
									<!--end::Logo-->
									<!--begin::Section-->
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Logo-->
									<img src="/media/svg/brand-logos/vue-9.svg" class="me-4 w-30px" alt="" />
									<!--end::Logo-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<!--begin::Text-->
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Logo-->
									<img src="/media/svg/brand-logos/bootstrap5.svg" class="me-4 w-30px" alt="" />
									<!--end::Logo-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<!--begin::Text-->
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Logo-->
									<img src="/media/svg/brand-logos/angular-icon.svg" class="me-4 w-30px" alt="" />
									<!--end::Logo-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<!--begin::Text-->
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Logo-->
									<img src="/media/svg/brand-logos/spring-3.svg" class="me-4 w-30px" alt="" />
									<!--end::Logo-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<!--begin::Text-->
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Logo-->
									<img src="/media/svg/brand-logos/typescript-1.svg" class="me-4 w-30px" alt="" />
									<!--end::Logo-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<!--begin::Text-->
