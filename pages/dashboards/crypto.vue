					...
					<div class="row g-5 g-xl-10">
						...
						<div class="col-md-4">
							...
							<div class="card card-flush h-xl-100" style="background-color: #F6E5CA">
								...
								<div class="card-body text-center pt-5">
									<!--begin::Image-->
									<img src="/media/svg/shapes/bitcoin.svg" class="h-125px mb-5" alt="" />
									<!--end::Image-->
									<!--begin::Section-->
						...
						<div class="col-md-4">
							...
							<div class="card card-flush h-xl-100" style="background-color: #F3D6EF">
								...
								<div class="card-body text-center pt-5">
									<!--begin::Image-->
									<img src="/media/svg/shapes/ethereum.svg" class="h-125px mb-5" alt="" />
									<!--end::Image-->
									<!--begin::Section-->
									<div class="text-start">
								...
								<div class="tab-pane fade active show" id="kt_forms_widget_1_tab_content_1">
									...
									<div class="form-floating border border-gray-300 rounded mb-7">
										<select class="form-select form-select-transparent" id="kt_forms_widget_1_select_1">
											<option></option>
											<option value="0" data-kt-select2-icon="/media/svg/coins/bitcoin.svg" selected="selected">
												Bitcoin/BTC</option>
											<option value="1" data-kt-select2-icon="/media/svg/coins/ethereum.svg">Ethereum/ETH</option>
											<option value="2" data-kt-select2-icon="/media/svg/coins/filecoin.svg">Filecoin/FLE</option>
											<option value="3" data-kt-select2-icon="/media/svg/coins/chainlink.svg">Chainlink/CIN</option>
											<option value="4" data-kt-select2-icon="/media/svg/coins/binance.svg">Binance/BCN</option>
										</select>
					...
					<div class="card h-md-100">
						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="text-center mb-1">
								...
								<!--end::Link-->
								<!--begin::Link-->
								<a class="btn btn-sm btn-light" href="../../demo6/dist/apps/ecommerce/sales/listing.html">Learn More</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
						</div>
				...
				<div class="col-xxl-4">
					...
					<div class="card card-flush h-xl-100">
								...
								<div class="d-flex align-items-center">
									...
									<div class="d-flex flex-center">
										...
										<div class="form-check form-switch form-check-custom form-check-solid">
											<input class="form-check-input h-20px w-30px" type="checkbox" value="" id="flexSwitchChecked"
												checked="checked" />
										</div>
										<!--end::Action-->
									</div>
						...
						<div class="card-footer mx-auto pt-0">
							...
							<a href="#" class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">Buy
								GPU</a>
							<!--end::Actions-->
						</div>
						<!--end::Footer-->
