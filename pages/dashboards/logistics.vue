						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="mb-2">
								...
								<div class="py-10 text-center">
									<img src="/media/svg/illustrations/easy/3.svg" class="theme-light-show w-200px" alt="" />
									<img src="/media/svg/illustrations/easy/3-dark.svg" class="theme-dark-show w-200px" alt="" />
								</div>
								<!--end::Illustration-->
							</div>
							<!--end::Heading-->
							...
							<div class="text-center mb-1">
								...
								<!--end::Link-->
								<!--begin::Link-->
								<a class="btn btn-sm btn-light" href="../../demo6/dist/apps/invoices/view/invoice-2.html">Quick Guide</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
						</div>
							...
							<div class="card card-flush h-lg-100">
								...
								<div class="card-body pt-0">
									...
									<div class="d-flex flex-stack">
										<!--begin::Flag-->
										<img src="/media/flags/united-states.svg" class="me-4 w-25px" style="border-radius: 4px"
											alt="" />
										<!--end::Flag-->
										<!--begin::Section-->
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body pt-4">
							...
							<div class="text-center pt-9">
								<a href="../../demo6/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-primary">Add Vehicle</a>
							</div>
						</div>
						<!--end::Body-->
					</div>
