						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="mb-2">
								...
								<div class="py-10 text-center">
									<img src="/media/svg/illustrations/easy/1.svg" class="theme-light-show w-200px" alt="" />
									<img src="/media/svg/illustrations/easy/1-dark.svg" class="theme-dark-show w-200px" alt="" />
								</div>
								<!--end::Illustration-->
							</div>
							<!--end::Heading-->
							...
							<div class="text-center mb-1">
								...
								<!--end::Link-->
								<!--begin::Link-->
								<a class="btn btn-sm btn-light" href="../../demo6/dist/pages/user-profile/activity.html">Learn more</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
						</div>
				...
				<div class="col-sm-6 col-xl-2 mb-xl-10">
					...
					<div class="card h-lg-100">
						...
						<div class="card-body d-flex justify-content-between align-items-start flex-column">
							<!--begin::Icon-->
							<div class="m-0">
								<img src="/media/svg/brand-logos/instagram-2-1.svg" class="w-35px" alt="" />
							</div>
							<!--end::Icon-->
							<!--begin::Section-->
				...
				<div class="col-sm-6 col-xl-2 mb-xl-10">
					...
					<div class="card h-lg-100">
						...
						<div class="card-body d-flex justify-content-between align-items-start flex-column">
							<!--begin::Icon-->
							<div class="m-0">
								<img src="/media/svg/brand-logos/facebook-3.svg" class="w-35px" alt="" />
							</div>
							<!--end::Icon-->
							<!--begin::Section-->
							<div class="d-flex flex-column my-7">
				...
				<div class="col-sm-6 col-xl-2 mb-xl-10">
					...
					<div class="card h-lg-100">
						...
						<div class="card-body d-flex justify-content-between align-items-start flex-column">
							<!--begin::Icon-->
							<div class="m-0">
								<img src="/media/svg/brand-logos/dribbble-icon-1.svg" class="w-35px" alt="" />
							</div>
							<!--end::Icon-->
							<!--begin::Section-->
							<div class="d-flex flex-column my-7">
				...
				<div class="col-sm-6 col-xl-2 mb-xl-10">
					...
					<div class="card h-lg-100">
						...
						<div class="card-body d-flex justify-content-between align-items-start flex-column">
							<!--begin::Icon-->
							<div class="m-0">
								<img src="/media/svg/brand-logos/twitter.svg" class="w-35px" alt="" />
							</div>
							<!--end::Icon-->
							<!--begin::Section-->
							<div class="d-flex flex-column my-7">
								...
								<ul class="nav">
									...
									<li class="nav-item">
										<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1"
											data-kt-timeline-widget-1="tab" data-bs-toggle="tab" href="#kt_timeline_widget_1_tab_week">Week</a>
									</li>
									<li class="nav-item">
										<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1"
								...
								<div class="tab-pane active" id="kt_timeline_widget_1_tab_day" role="tabpanel" aria-labelledby="day-tab"
									...
									<div class="table-responsive pb-10">
										...
										<div id="kt_timeline_widget_1_1" class="vis-timeline-custom h-350px min-w-700px"
											data-kt-timeline-widget-1-image-root="/media/"></div>
										<!--end::Timeline-->
									</div>
								</div>
								<!--end::Tab pane-->
									...
									<div class="mb-3">
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex flex-column align-items-end w-100 mw-250px overflow-hidden">
												<!--begin::Select-->
												<div class="mb-2">
													<select class="form-select form-select-transparent p-0 w-150px me-n5" data-control="select2"
														data-placeholder="All Users" data-dropdown-css-class="w-150px" data-hide-search="true">
												...
												<div class="progress h-6px w-100 bg-light">
													<div class="progress-bar bg-warning" role="progressbar" style="width: 65%" aria-valuemin="0"
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex flex-column align-items-end w-100 mw-250px overflow-hidden">
												...
												<!--begin::Progress-->
												<div class="progress h-6px w-100 bg-light">
													<div class="progress-bar bg-warning" role="progressbar" style="width: 45%" aria-valuemin="0"
														aria-valuemax="100"></div>
												</div>
												<!--end::Progress-->
											</div>
										...
										<div class="d-flex flex-stack">
											...
											<div class="d-flex flex-column align-items-end w-100 mw-250px overflow-hidden">
												...
												<!--begin::Progress-->
												<div class="progress h-6px w-100 bg-light">
													<div class="progress-bar bg-warning" role="progressbar" style="width: 85%" aria-valuemin="0"
														aria-valuemax="100"></div>
												</div>
												<!--end::Progress-->
											</div>
											...
											<div class="mb-10">
												...
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true"
														data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df248389aa"
									...
									<tr>
										...
										<td>
											...
											<div class="d-flex gap-2 mb-2">
												<a href="#">
													<img src="/media/svg/brand-logos/facebook-4.svg" class="w-20px" alt="" />
												</a>
												<a href="#">
													<img src="/media/svg/brand-logos/twitter-2.svg" class="w-20px" alt="" />
												</a>
												<a href="#">
													<img src="/media/svg/brand-logos/linkedin-2.svg" class="w-20px" alt="" />
												</a>
												<a href="#">
													<img src="/media/svg/brand-logos/youtube-3.svg" class="w-20px" alt="" />
												</a>
											</div>
											<!--end::Icons-->
									...
									<tr>
										...
										<td>
											...
											<div class="d-flex gap-2 mb-2">
												...
												<a href="#">
													<img src="/media/svg/brand-logos/instagram-2-1.svg" class="w-20px" alt="" />
												</a>
												<a href="#">
													<img src="/media/svg/brand-logos/youtube-3.svg" class="w-20px" alt="" />
												</a>
							...
							<div class="mb-5 px-9">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-3">
										<!--begin::Icon-->
										<img src="/media/svg/brand-logos/dribbble-icon-1.svg" class="me-3 w-30px" alt="" />
										<!--end::Icon-->
										<!--begin::Section-->
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-3">
										<!--begin::Icon-->
										<img src="/media/svg/brand-logos/instagram-2-1.svg" class="me-3 w-30px" alt="" />
										<!--end::Icon-->
										<!--begin::Section-->
										<div class="flex-grow-1">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-3">
										<!--begin::Icon-->
										<img src="/media/svg/brand-logos/slack-icon.svg" class="me-3 w-30px" alt="" />
										<!--end::Icon-->
										<!--begin::Section-->
										<div class="flex-grow-1">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-3">
										<!--begin::Icon-->
										<img src="/media/svg/brand-logos/google-icon.svg" class="me-3 w-30px" alt="" />
										<!--end::Icon-->
										<!--begin::Section-->
										<div class="flex-grow-1">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-3">
										<!--begin::Icon-->
										<img src="/media/svg/brand-logos/invision.svg" class="me-3 w-30px" alt="" />
										<!--end::Icon-->
										<!--begin::Section-->
										<div class="flex-grow-1">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-3">
										<!--begin::Icon-->
										<img src="/media/svg/brand-logos/facebook-3.svg" class="me-3 w-30px" alt="" />
										<!--end::Icon-->
										<!--begin::Section-->
										<div class="flex-grow-1">
