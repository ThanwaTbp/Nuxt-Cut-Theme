						...
						<div class="card-body d-flex flex-column pt-13 pb-14">
							...
							<div class="m-0">
								...
								<div
									...
									style="background-image:url('/media/svg/illustrations/easy/5.svg')"></div>
								<!--end::Illustration-->
							</div>
							<!--end::Heading-->
							<!--begin::Links-->
							<div class="text-center">
								...
								<a class="btn btn-sm bg-white btn-color-white bg-opacity-20"
									href="../../demo6/dist/pages/user-profile/projects.html">Quick Guide</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
						</div>
				...
				<div class="col-xl-4 mb-xl-10">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-header pt-7">
							...
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<a href="../../demo6/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">Add
									Product</a>
							</div>
							<!--end::Toolbar-->
						</div>
						...
						<div class="card-body pt-0">
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Icon-->
									<img src="/media/stock/ecommerce/14.gif" class="me-4 w-50px" alt="" />
									<!--end::Icon-->
									<!--begin::Section-->
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Icon-->
									<img src="/media/stock/ecommerce/13.gif" class="me-4 w-50px" alt="" />
									<!--end::Icon-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<a href="../../demo6/dist/apps/ecommerce/sales/details.html"
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Icon-->
									<img src="/media/stock/ecommerce/41.gif" class="me-4 w-50px" alt="" />
									<!--end::Icon-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<a href="../../demo6/dist/apps/ecommerce/sales/details.html"
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Icon-->
									<img src="/media/stock/ecommerce/53.gif" class="me-4 w-50px" alt="" />
									<!--end::Icon-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<a href="../../demo6/dist/apps/ecommerce/sales/details.html"
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Icon-->
									<img src="/media/stock/ecommerce/71.gif" class="me-4 w-50px" alt="" />
									<!--end::Icon-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<a href="../../demo6/dist/apps/ecommerce/sales/details.html"
							...
							<div class="d-flex flex-stack">
								...
								<div class="d-flex align-items-center me-3">
									<!--begin::Icon-->
									<img src="/media/stock/ecommerce/194.gif" class="me-4 w-50px" alt="" />
									<!--end::Icon-->
									<!--begin::Section-->
									<div class="flex-grow-1">
										<a href="../../demo6/dist/apps/ecommerce/sales/details.html"
						...
						<div class="card-header pt-7">
							...
							<div class="card-toolbar">
								<ul class="nav me-n1" id="kt_chart_widget_11_tabs">
									<li class="nav-item">
										<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1"
											data-bs-toggle="tab" id="kt_list_widget_18_tab_1" href="#kt_list_widget_18_tab_content_1">2021</a>
									</li>
									<li class="nav-item">
										<a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 active"
											data-bs-toggle="tab" id="kt_list_widget_18_tab_2" href="#kt_list_widget_18_tab_content_2">Month</a>
									</li>
								</ul>
							</div>
							<!--end::Toolbar-->
								...
								<div class="tab-pane fade" id="kt_list_widget_18_tab_content_1">
									...
									<div class="d-flex flex-stack">
										...
										<div class="d-flex align-items-center me-5">
											<!--begin::Flag-->
											<img src="/media/svg/brand-logos/kickstarter.svg" class="me-4 w-30px"
									...
									<div class="d-flex flex-stack">
										...
										<div class="d-flex align-items-center me-5">
											<!--begin::Flag-->
											<img src="/media/svg/brand-logos/telegram-2.svg" class="me-4 w-30px"
												style="border-radius: 4px" alt="" />
											<!--end::Flag-->
											<!--begin::Content-->
											<div class="me-5">
