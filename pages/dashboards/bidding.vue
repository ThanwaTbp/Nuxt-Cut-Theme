								...
								<div class="col-sm-6">
									...
									<div class="d-flex flex-column h-100">
										...
										<div class="d-flex flex-stack mt-auto bd-highlight">
											...
											<a href="#" class="btn btn-light btn-sm flex-shrink-0" data-bs-toggle="modal"
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body text-center pb-5">
							...
							<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
								href="/media/stock/600x600/img-39.jpg">
								<!--begin::Image-->
								<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
									style="height: 266px;background-image:url('/media/stock/600x600/img-39.jpg')"></div>
								<!--end::Image-->
								<!--begin::Action-->
								<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
									<i class="bi bi-eye-fill fs-2x text-white"></i>
							...
							<div class="d-flex align-items-end flex-stack mb-1">
								...
								<div class="text-start">
									<span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Wavy Curved
										Art</span>
						...
						<div class="card-footer d-flex flex-stack pt-0">
							...
							<!--end::Link-->
							<!--begin::Link-->
							<a class="btn btn-sm btn-light flex-shrink-0" href="../../demo6/dist/apps/ecommerce/sales/listing.html">View
								Item</a>
							<!--end::Link-->
						</div>
						<!--end::Footer-->
				...
				<div class="col-sm-6 col-xxl-3">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-body text-center pb-5">
							<!--begin::Overlay-->
							<a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
								href="/media/stock/600x600/img-47.jpg">
								<!--begin::Image-->
								<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded mb-7"
									style="height: 266px;background-image:url('/media/stock/600x600/img-47.jpg')"></div>
								<!--end::Image-->
								<!--begin::Action-->
								<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
									<i class="bi bi-eye-fill fs-2x text-white"></i>
							...
							<div class="d-flex align-items-end flex-stack mb-1">
								<!--begin::Title-->
								<div class="text-start">
									<span class="fw-bold text-gray-800 cursor-pointer text-hover-primary fs-4 d-block">Happy Kitty
										Art</span>
				...
				<div class="col-xl-8">
					...
					<div class="card card-flush h-xl-100">
						...
						<div class="card-header pt-7">
							...
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<a href="../../demo6/dist/apps/ecommerce/catalog/add-product.html"
									...
									<tbody>
											...
											<td>
												<div class="d-flex align-items-center">
													<div class="symbol symbol-50px me-3">
														<img src="/media/stock/600x600/img-49.jpg" class="" alt="" />
													</div>
											...
											<td class="pe-0">
												<div class="d-flex align-items-center justify-content-end">
													<div class="symbol symbol-30px me-3">
														<img src="/media/avatars/300-13.jpg" class="" alt="" />
													</div>
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="symbol symbol-50px me-3">
														<img src="/media/stock/600x600/img-43.jpg" class="" alt="" />
													</div>
													<div class="d-flex justify-content-start flex-column">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="symbol symbol-50px me-3">
														<img src="/media/stock/600x600/img-46.jpg" class="" alt="" />
													</div>
													<div class="d-flex justify-content-start flex-column">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="symbol symbol-50px me-3">
														<img src="/media/stock/600x600/img-54.jpg" class="" alt="" />
													</div>
													<div class="d-flex justify-content-start flex-column">
										...
										<tr>
											<td>
												<div class="d-flex align-items-center">
													<div class="symbol symbol-50px me-3">
														<img src="/media/stock/600x600/img-45.jpg" class="" alt="" />
													</div>
													<div class="d-flex justify-content-start flex-column">
							...
							<div class="">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-5">
										<!--begin::Flag-->
										<img src="/media/svg/brand-logos/atica.svg" class="me-4 w-30px" style="border-radius: 4px"
											alt="" />
										<!--end::Flag-->
										<!--begin::Content-->
										<div class="me-5">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-5">
										<!--begin::Flag-->
										<img src="/media/svg/brand-logos/telegram-2.svg" class="me-4 w-30px" style="border-radius: 4px"
											alt="" />
										<!--end::Flag-->
										<!--begin::Content-->
										<div class="me-5">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-5">
										<!--begin::Flag-->
										<img src="/media/svg/brand-logos/balloon.svg" class="me-4 w-30px" style="border-radius: 4px"
											alt="" />
										<!--end::Flag-->
										<!--begin::Content-->
										<div class="me-5">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-5">
										<!--begin::Flag-->
										<img src="/media/svg/brand-logos/kickstarter.svg" class="me-4 w-30px" style="border-radius: 4px"
											alt="" />
										<!--end::Flag-->
										<!--begin::Content-->
										<div class="me-5">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-5">
										<!--begin::Flag-->
										<img src="/media/svg/brand-logos/vimeo.svg" class="me-4 w-30px" style="border-radius: 4px"
											alt="" />
										<!--end::Flag-->
										<!--begin::Content-->
										<div class="me-5">
								...
								<div class="d-flex flex-stack">
									...
									<div class="d-flex align-items-center me-5">
										<!--begin::Flag-->
										<img src="/media/svg/brand-logos/plurk.svg" class="me-4 w-30px" style="border-radius: 4px"
											alt="" />
										<!--end::Flag-->
										<!--begin::Content-->
										<div class="me-5">
					...
					<div class="card h-md-100">
						...
						<div class="card-body d-flex flex-column flex-center">
							...
							<div class="text-center mb-1">
								<!--begin::Link-->
								<a class="btn btn-sm btn-primary me-2" data-bs-target="#kt_modal_create_app" data-bs-toggle="modal">Try
									Now</a>
								<!--end::Link-->
								<!--begin::Link-->
								<a class="btn btn-sm btn-light" href="../../demo6/dist/account/settings.html">Learn More</a>
								<!--end::Link-->
							</div>
							<!--end::Links-->
						</div>
