				...
				<div class="col-xl-4">
					...
					<div
						...
						<div class="card-body">
							...
							<p class="text-dark-75 fw-semibold fs-5 m-0">Great blog posts don’t just happen Even the best bloggers need
								it</p>
						</div>
						<!--end::Body-->
					</div>
				...
				<div class="col-xl-4">
					...
					<div
						...
						<div class="card-body">
							...
							<p class="text-dark-75 fw-semibold fs-5 m-0">AirWays - A Front-end solution for airlines build with ReactJS
							</p>
						</div>
						<!--end::Body-->
					</div>
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
						...
						<div class="card-body d-flex align-items-center pt-3 pb-0">
							...
							<img src="/media/svg/avatars/029-boy-11.svg" alt="" class="align-self-end h-100px" />
						</div>
						<!--end::Body-->
					</div>
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
						...
						<div class="card-body d-flex align-items-center pt-3 pb-0">
							...
							<img src="/media/svg/avatars/014-girl-7.svg" alt="" class="align-self-end h-100px" />
						</div>
						<!--end::Body-->
					</div>
					<!--end::Statistics Widget 2-->
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-5 mb-xl-8">
						...
						<div class="card-body d-flex align-items-center pt-3 pb-0">
							...
							<img src="/media/svg/avatars/004-boy-1.svg" alt="" class="align-self-end h-100px" />
						</div>
						<!--end::Body-->
					</div>
					<!--end::Statistics Widget 2-->
