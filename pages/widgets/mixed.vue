			...
			<div class="row g-5 g-xl-8">
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
						...
						<div class="card-body p-0">
							<!--begin::Chart-->
							<div class="mixed-widget-2-chart card-rounded-bottom bg-info" data-kt-color="info" style="height: 200px">
							</div>
							<!--end::Chart-->
							<!--begin::Stats-->
			...
			<div class="row g-5 g-xl-8">
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
						...
						<div class="card-body p-0">
							<!--begin::Chart-->
							<div class="mixed-widget-12-chart card-rounded-bottom bg-danger" data-kt-color="danger"
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df3650a551"
						...
						<div class="card-body p-0 d-flex flex-column">
							...
							<!--end::Stats-->
							<!--begin::Chart-->
							<div class="mixed-widget-3-chart card-rounded-bottom" data-kt-chart-color="primary" style="height: 150px">
							</div>
							<!--end::Chart-->
						</div>
						<!--end::Body-->
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df36511f4b"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
						...
						<div class="card-body p-0 d-flex flex-column">
							...
							<!--end::Stats-->
							<!--begin::Chart-->
							<div class="mixed-widget-3-chart card-rounded-bottom" data-kt-chart-color="danger" style="height: 150px">
							</div>
							<!--end::Chart-->
						</div>
						<!--end::Body-->
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-5 mb-xl-8">
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df365193ba"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
						...
						<div class="card-body p-0 d-flex flex-column">
							...
							<!--end::Stats-->
							<!--begin::Chart-->
							<div class="mixed-widget-3-chart card-rounded-bottom" data-kt-chart-color="success" style="height: 150px">
							</div>
							<!--end::Chart-->
						</div>
						<!--end::Body-->
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df3651eb53"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df36522ed9"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df3652715a"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
			...
			<div class="row g-5 g-xl-8">
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
						...
						<div class="card-body d-flex flex-column">
							<!--begin::Chart-->
							<div class="mixed-widget-5-chart card-rounded-top" data-kt-chart-color="primary" style="height: 150px">
							</div>
							<!--end::Chart-->
							<!--begin::Items-->
							<div class="mt-5">
					...
					<div class="card card-xl-stretch mb-xl-8">
						...
						<div class="card-body pt-5">
							...
							<div class="text-center w-100 position-relative z-index-1" style="margin-top: -130px">
								...
								<!--begin::Action-->
								<div class="mb-9 mb-xxl-1">
									<a href='#' class="btn btn-info fw-semibold" data-bs-toggle="modal"
										data-bs-target="#kt_modal_invite_friends">Increase Users</a>
								</div>
								<!--ed::Action-->
							</div>
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df36541700"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df3654a7b8"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
						...
						<div class="card-body p-0 d-flex flex-column">
							...
							<!--end::Stats-->
							<!--begin::Chart-->
							<div class="mixed-widget-6-chart card-rounded-bottom" data-kt-chart-color="success" style="height: 150px">
							</div>
							<!--end::Chart-->
						</div>
						<!--end::Body-->
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-5 mb-xl-8">
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df365525e3"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
						...
						<div class="card-body p-0 d-flex flex-column">
							...
							<!--end::Stats-->
							<!--begin::Chart-->
							<div class="mixed-widget-6-chart card-rounded-bottom" data-kt-chart-color="danger" style="height: 150px">
							</div>
							<!--end::Chart-->
						</div>
						<!--end::Body-->
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
						...
						<div class="card-body d-flex flex-column p-0">
							...
							<!--end::Stats-->
							<!--begin::Chart-->
							<div class="mixed-widget-7-chart card-rounded-bottom" data-kt-chart-color="info" style="height: 150px">
							</div>
							<!--end::Chart-->
						</div>
						<!--end::Body-->
				...
				<div class="col-xl-4">
					...
					<div class="card card-xl-stretch mb-xl-8">
						...
						<div class="card-body d-flex flex-column p-0">
							...
							<!--end::Stats-->
							<!--begin::Chart-->
							<div class="mixed-widget-7-chart card-rounded-bottom" data-kt-chart-color="warning" style="height: 150px">
							</div>
							<!--end::Chart-->
						</div>
						<!--end::Body-->
									...
									<div class="d-flex align-items-center mb-9 ms-2">
										...
										<div class="symbol symbol-40px me-3">
											<div class="symbol-label bg-light">
												...
												<span class="svg-icon svg-icon-1 svg-icon-dark">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
														<path d="M8 22C7.4 22 7 21.6 7 21V9C7 8.4 7.4 8 8 8C8.6 8 9 8.4 9 9V21C9 21.6 8.6 22 8 22Z"
															fill="currentColor" />
														<path opacity="0.3"
