								...
								<ul class="nav nav-pills nav-pills-custom flex-column border-transparent fs-5 fw-bold">
									...
									<li class="nav-item mt-5">
										<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0 active"
											href="../../demo6/dist/pages/social/feeds.html">
									...
									<li class="nav-item mt-5">
										<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0"
											href="../../demo6/dist/pages/social/activity.html">
									...
									<li class="nav-item mt-5">
										<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0"
											href="../../demo6/dist/pages/social/followers.html">
									...
									<li class="nav-item mt-5">
										<a class="nav-link text-muted text-active-primary ms-0 py-0 me-10 ps-9 border-0"
											href="../../demo6/dist/pages/social/settings.html">
						...
						<div class="card-body pt-6">
							...
							<div class="timeline-label">
								...
								<div class="timeline-item">
									...
									<!--end::Badge-->
									<!--begin::Text-->
									<div class="fw-semibold text-gray-700 ps-3 fs-7">Outlines keep you honest. Indulging in poorly driving
								...
								<div class="timeline-item">
									...
									<!--begin::Text-->
									<div class="fw-semibold text-gray-700 ps-3 fs-7">Outlines keep you honest. Indulging in poorly driving
										and keep structure keep you honest great</div>
									<!--end::Text-->
								</div>
								<!--end::Item-->
								<!--begin::Item-->
				...
				<div class="w-100 flex-lg-row-fluid mx-lg-13">
					...
					<div class="card card-flush mb-10">
						...
						<div class="card-footer d-flex justify-content-end pt-0">
							<!--begin::Post action-->
							<a href="../../demo6/dist/pages/blog/post.html" class="btn btn-sm btn-primary"
					...
					<div class="mb-10" id="kt_social_feeds_posts">
						...
						<div class="card card-flush mb-10">
							...
							<div class="card-header pt-9">
								...
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-50px me-5">
										<img src="/media/avatars/300-4.jpg" class="" alt="" />
									</div>
									<!--end::Avatar-->
									<!--begin::Info-->
							...
							<div class="card-body">
								<!--begin::Post content-->
								<div class="fs-6 fw-normal text-gray-700 mb-5">There are two main approaches you can take to writing
									amazing blog post headlines. You can either decide on your final headline before outstanding you write
									the most of the rest of your creative post</div>
								<!--end::Post content-->
								<!--begin::Post media-->
								<div class="row g-7 h-250px h-md-375px">
									...
									<div class="col-6">
										...
										<a class="d-block card-rounded overlay h-100" data-fslightbox="lightbox-projects"
											href="/media/stock/600x600/img-23.jpg">
											<!--begin::Image-->
											<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"
												style="background-image:url('/media/stock/600x600/img-23.jpg')"></div>
											<!--end::Image-->
											<!--begin::Action-->
									...
									<div class="col-6">
										...
										<div class="row g-7 h-250px h-md-375px">
											...
											<div class="col-lg-12">
												<!--begin::Item-->
												<a class="d-block card-rounded overlay h-100" data-fslightbox="lightbox-projects"
													href="/media/stock/600x600/img-22.jpg">
													<!--begin::Image-->
													<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"
														style="background-image:url('/media/stock/600x400/img-71.jpg')"></div>
													<!--end::Image-->
													<!--begin::Action-->
													<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
														<i class="bi bi-eye-fill fs-3x text-white"></i>
											...
											<div class="col-lg-12">
												<!--begin::Item-->
												<a class="d-block card-rounded overlay h-100" data-fslightbox="lightbox-projects"
													href="/media/stock/600x600/img-21.jpg">
													<!--begin::Image-->
													<div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"
														style="background-image:url('/media/stock/600x400/img-79.jpg')"></div>
													<!--end::Image-->
													<!--begin::Action-->
													<div class="overlay-layer card-rounded bg-dark bg-opacity-25">
														<i class="bi bi-eye-fill fs-3x text-white"></i>
									...
									<ul class="nav py-3">
										...
										<li class="nav-item">
											<a class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible active"
												...
												<i class="bi bi-chat-square fs-2 me-1"></i>2 Comments</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item">
											<a href="#"
												...
												<i class="bi bi-heart fs-2 me-1"></i>47k Likes</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item">
											<a href="#" class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4">
												<i class="bi bi-bookmark fs-2 me-1"></i>900 Saves</a>
										</li>
										<!--end::Item-->
									</ul>
									<!--end::Nav-->
									...
									<div class="collapse show" id="kt_social_feeds_comments_1">
										...
										<div class="d-flex pt-6">
											...
											<div class="d-flex flex-column flex-row-fluid">
												...
												<!--end::Info-->
												<!--begin::Text-->
												<span class="text-gray-800 fs-7 fw-normal pt-1">Long before you sit dow to put digital pen to
													paper you need to make sure you have to sit down and write.</span>
												<!--end::Text-->
											</div>
											<!--end::Wrapper-->
										</div>
						...
						<div class="card card-flush mb-10">
							...
							<div class="card-header pt-9">
								...
								<div class="d-flex align-items-center">
									<!--begin::Avatar-->
									<div class="symbol symbol-50px me-5">
										<img src="/media/avatars/300-7.jpg" class="" alt="" />
									</div>
									<!--end::Avatar-->
									<!--begin::Info-->
									<div class="flex-grow-1">
							...
							<div class="card-body">
								<!--begin::Post content-->
								<div class="fs-6 fw-normal text-gray-700">You can either decide on your final headline before outstanding
									you write the most of the rest of your creative post</div>
								<!--end::Post content-->
							</div>
							<!--end::Card body-->
							<!--begin::Card footer-->
						...
						<div class="card card-flush mb-10">
							...
							<div class="card-body">
								<!--begin::Post content-->
								<div class="fs-6 fw-normal text-gray-700 mb-5">You can either decide on your final headline before
									...
									<ul class="nav py-3">
										...
										<li class="nav-item">
											<a class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible"
												...
												<i class="bi bi-chat-square fs-2 me-1"></i>4 Comments</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item">
											<a href="#"
												class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4 me-1">
												<i class="bi bi-heart fs-2 me-1"></i>10k Likes</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item">
											<a href="#" class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4">
												<i class="bi bi-bookmark fs-2 me-1"></i>2 Saves</a>
										</li>
										<!--end::Item-->
									</ul>
									<!--end::Nav-->
						...
						<div class="card card-flush mb-10">
							...
							<div class="card-header pt-9">
								...
								<div class="d-flex align-items-center">
									<!--begin::Avatar-->
									<div class="symbol symbol-50px me-5">
										<img src="/media/avatars/300-10.jpg" class="" alt="" />
									</div>
									<!--end::Avatar-->
									<!--begin::Info-->
									<div class="flex-grow-1">
									...
									<ul class="nav py-3">
										...
										<li class="nav-item">
											<a class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible"
												...
												<i class="bi bi-chat-square fs-2 me-1"></i>10 Comments</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item">
										...
										<li class="nav-item">
											<a href="#" class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4">
												<i class="bi bi-bookmark fs-2 me-1"></i>3k Saves</a>
										</li>
										<!--end::Item-->
									</ul>
									<!--end::Nav-->
								...
								<div class="card-body">
									...
									<div class="row g-3 g-lg-6">
										...
										<div class="col-md-6 col-lg-4">
											<!--begin::Img-->
											<a href="">
												<img src="/media/stock/600x600/img-14.jpg" class="rounded w-100" alt="" />
											</a>
											<!--end::Img-->
										</div>
										<!--end::Col-->
										...
										<div class="col-md-6 col-lg-4">
											<!--begin::Img-->
											<a href="">
												<img src="/media/stock/600x600/img-10.jpg" class="rounded w-100" alt="" />
											</a>
											<!--end::Img-->
										</div>
										<!--end::Col-->
										...
										<div class="col-md-6 col-lg-4">
											<!--begin::Img-->
											<a href="">
												<img src="/media/stock/600x600/img-18.jpg" class="rounded w-100" alt="" />
											</a>
											<!--end::Img-->
										</div>
										<!--end::Col-->
										...
										<div class="col-md-6 col-lg-4">
											<!--begin::Img-->
											<a href="">
												<img src="/media/stock/600x600/img-30.jpg" class="rounded w-100" alt="" />
											</a>
											<!--end::Img-->
										</div>
										<!--end::Col-->
										...
										<div class="col-md-6 col-lg-4">
											<!--begin::Img-->
											<a href="">
												<img src="/media/stock/600x600/img-31.jpg" class="rounded w-100" alt="" />
											</a>
											<!--end::Img-->
										</div>
										<!--end::Col-->
									...
									<div class="mb-6">
										...
										<ul class="nav py-3">
											...
											<li class="nav-item">
												<a href="#"
													class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4 me-1">
													<i class="bi bi-heart fs-2 me-1"></i>15k Likes</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="nav-item">
												<a href="#" class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4">
													<i class="bi bi-bookmark fs-2 me-1"></i>3.8k Saves</a>
											</li>
											<!--end::Item-->
										</ul>
										<!--end::Nav-->
							...
							<div class="card card-flush mb-10">
								...
								<div class="card-header pt-9">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-50px me-5">
											<img src="/media/avatars/300-12.jpg" class="" alt="" />
										</div>
										<!--end::Avatar-->
										<!--begin::Info-->
										<div class="flex-grow-1">
									...
									<div class="mb-6">
										...
										<ul class="nav py-3">
											...
											<li class="nav-item">
												<a href="#"
													class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4 me-1">
													<i class="bi bi-heart fs-2 me-1"></i>14k Likes</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
											<li class="nav-item">
												<a href="#" class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4">
													<i class="bi bi-bookmark fs-2 me-1"></i>7.5k Saves</a>
											</li>
											<!--end::Item-->
										</ul>
										<!--end::Nav-->
					...
					<div class="d-none" id="kt_social_feeds_new_post">
						...
						<div class="card card-flush mb-10">
							...
							<div class="card-body">
								<!--begin::Post content-->
								<div class="fs-6 fw-normal text-gray-700" data-kt-post-element="content">You can either decide on your
									final headline before outstanding you write the most of the rest of your creative post</div>
								<!--end::Post content-->
							</div>
							<!--end::Card body-->
							<!--begin::Card footer-->
								...
								<div class="mb-6">
									...
									<ul class="nav py-3">
										...
										<li class="nav-item">
											<a class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary btn-active-light-primary fw-bold px-4 me-1 collapsible"
												data-bs-toggle="collapse" href="#kt_social_feeds_comments_2">
												<i class="bi bi-chat-square fs-2 me-1"></i>0 Comment</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item">
											<a href="#"
												class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4 me-1">
												<i class="bi bi-heart fs-2 me-1"></i>0 Like</a>
										</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="nav-item">
											<a href="#" class="nav-link btn btn-sm btn-color-gray-600 btn-active-color-primary fw-bold px-4">
												<i class="bi bi-bookmark fs-2 me-1"></i>0 Saves</a>
										</li>
										<!--end::Item-->
									</ul>
									<!--end::Nav-->
				...
				<div class="d-lg-flex flex-column flex-lg-row-auto w-lg-325px" data-kt-drawer="true"
						...
						<div class="card-body pt-5">
							...
							<div class="d-flex flex-stack">
								...
								<div class="symbol symbol-40px me-5">
									<img src="/media/avatars/300-11.jpg" class="h-50 align-self-center" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
							...
							<div class="d-flex flex-stack">
								<!--begin::Symbol-->
								<div class="symbol symbol-40px me-5">
									<img src="/media/avatars/300-2.jpg" class="h-50 align-self-center" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
							...
							<div class="d-flex flex-stack">
								<!--begin::Symbol-->
								<div class="symbol symbol-40px me-5">
									<img src="/media/avatars/300-7.jpg" class="h-50 align-self-center" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
							...
							<div class="d-flex flex-stack">
								<!--begin::Symbol-->
								<div class="symbol symbol-40px me-5">
									<img src="/media/avatars/300-9.jpg" class="h-50 align-self-center" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
							...
							<div class="d-flex flex-stack">
								<!--begin::Symbol-->
								<div class="symbol symbol-40px me-5">
									<img src="/media/avatars/300-12.jpg" class="h-50 align-self-center" alt="" />
								</div>
								<!--end::Symbol-->
								<!--begin::Section-->
								<div class="d-flex align-items-center flex-row-fluid flex-wrap">
					...
					<div class="card card-flush mb-5 mb-xl-8">
						...
						<div class="card-header pt-5">
							...
							<!--begin::Toolbar-->
							<div class="card-toolbar">
								<a href="../../demo6/dist/pages/social/activity.html" class="btn btn-sm btn-light">View All</a>
							</div>
							<!--end::Toolbar-->
						</div>
						<!--end::Header-->
						...
						<div class="card-body">
							...
							<div class="row g-3 g-lg-6">
								...
								<div class="col-md-6">
									<!--begin::Img-->
									<a href="">
										<img src="/media/stock/600x600/img-33.jpg" class="rounded w-100" alt="" />
									</a>
									<!--end::Img-->
								</div>
								<!--end::Col-->
								...
								<div class="col-md-6">
									<!--begin::Img-->
									<a href="">
										<img src="/media/stock/600x600/img-26.jpg" class="rounded w-100" alt="" />
									</a>
									<!--end::Img-->
								</div>
								<!--end::Col-->
								...
								<div class="col-md-6">
									<!--begin::Img-->
									<a href="">
										<img src="/media/stock/600x600/img-25.jpg" class="rounded w-100" alt="" />
									</a>
									<!--end::Img-->
								</div>
								<!--end::Col-->
								...
								<div class="col-md-6">
									<!--begin::Img-->
									<a href="">
										<img src="/media/stock/600x600/img-35.jpg" class="rounded w-100" alt="" />
									</a>
									<!--end::Img-->
								</div>
								<!--end::Col-->
