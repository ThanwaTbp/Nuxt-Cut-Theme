							...
							<div class="card">
								...
								<div class="card-body d-flex flex-center flex-column py-9 px-5">
									...
									<div class="symbol symbol-65px symbol-circle mb-5">
										<img src="/media//avatars/300-11.jpg" alt="image" />
										<div
						...
						<div class="col-md-6">
							...
							<div class="card">
								...
								<div class="card-body d-flex flex-center flex-column py-9 px-5">
									<!--begin::Avatar-->
									<div class="symbol symbol-65px symbol-circle mb-5">
										<img src="/media//avatars/300-14.jpg" alt="image" />
									</div>
									<!--end::Avatar-->
									<!--begin::Name-->
						...
						<div class="col-md-6">
							...
							<div class="card">
								...
								<div class="card-body d-flex flex-center flex-column py-9 px-5">
									<!--begin::Avatar-->
									<div class="symbol symbol-65px symbol-circle mb-5">
										<img src="/media//avatars/300-12.jpg" alt="image" />
									</div>
									<!--end::Avatar-->
									<!--begin::Name-->
						...
						<div class="col-md-6">
							...
							<div class="card">
								...
								<div class="card-body d-flex flex-center flex-column py-9 px-5">
									<!--begin::Avatar-->
									<div class="symbol symbol-65px symbol-circle mb-5">
										<img src="/media//avatars/300-7.jpg" alt="image" />
										<div
											class="bg-success position-absolute rounded-circle translate-middle start-100 top-100 border border-4 border-body h-15px w-15px ms-n3 mt-n3">
										</div>
									</div>
