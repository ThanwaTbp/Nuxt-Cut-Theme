				...
				<div class="d-flex align-items-center my-2">
					...
					<div class="w-100px me-5">
						...
						<select name="status" data-control="select2" data-hide-search="true"
							class="form-select form-select-sm bg-body border-body">
					...
					<!--end::Select wrapper-->
					<button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">Add
						Campaign</button>
				</div>
				<!--end::Controls-->
			</div>
						...
						<div class="card-header flex-nowrap border-0 pt-9">
							...
							<div class="card-title m-0">
								...
								<div class="symbol symbol-45px w-45px bg-light me-5">
									<img src="/media/svg/brand-logos/twitch.svg" alt="image" class="p-3" />
								</div>
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="card h-100">
						...
						<div class="card-header flex-nowrap border-0 pt-9">
							...
							<div class="card-title m-0">
								<!--begin::Icon-->
								<div class="symbol symbol-45px w-45px bg-light me-5">
									<img src="/media/svg/brand-logos/twitter.svg" alt="image" class="p-3" />
								</div>
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="card h-100">
						...
						<div class="card-header flex-nowrap border-0 pt-9">
							...
							<div class="card-title m-0">
								<!--begin::Icon-->
								<div class="symbol symbol-45px w-45px bg-light me-5">
									<img src="/media/svg/brand-logos/spotify.svg" alt="image" class="p-3" />
								</div>
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="card h-100">
						...
						<div class="card-header flex-nowrap border-0 pt-9">
							...
							<div class="card-title m-0">
								<!--begin::Icon-->
								<div class="symbol symbol-45px w-45px bg-light me-5">
									<img src="/media/svg/brand-logos/pinterest-p.svg" alt="image" class="p-3" />
								</div>
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="card h-100">
						...
						<div class="card-header flex-nowrap border-0 pt-9">
							...
							<div class="card-title m-0">
								<!--begin::Icon-->
								<div class="symbol symbol-45px w-45px bg-light me-5">
									<img src="/media/svg/brand-logos/github.svg" alt="image" class="p-3" />
								</div>
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="card h-100">
						...
						<div class="card-header flex-nowrap border-0 pt-9">
							...
							<div class="card-title m-0">
								<!--begin::Icon-->
								<div class="symbol symbol-45px w-45px bg-light me-5">
									<img src="/media/svg/brand-logos/youtube-play.svg" alt="image" class="p-3" />
								</div>
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="card h-100">
						...
						<div class="card-header flex-nowrap border-0 pt-9">
							...
							<div class="card-title m-0">
								<!--begin::Icon-->
								<div class="symbol symbol-45px w-45px bg-light me-5">
									<img src="/media/svg/brand-logos/telegram.svg" alt="image" class="p-3" />
								</div>
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="card h-100">
						...
						<div class="card-header flex-nowrap border-0 pt-9">
							...
							<div class="card-title m-0">
								<!--begin::Icon-->
								<div class="symbol symbol-45px w-45px bg-light me-5">
									<img src="/media/svg/brand-logos/reddit.svg" alt="image" class="p-3" />
								</div>
								<!--end::Icon-->
								<!--begin::Title-->
