							...
							<div class="mb-17">
								...
								<div class="m-0">
									...
									<p class="fw-semibold fs-4 text-gray-600 mb-2">First, a disclaimer – the entire process of writing a
										...
										your writing skills are sharp.</p>
									<!--end::Text-->
								</div>
								<!--end::Description-->
								<!--begin::Accordion-->
								...
								<!--end::Accordion-->
								<!--begin::Apply-->
								<a href="../../demo6/dist/pages/careers/apply.html" class="btn btn-sm btn-primary mt-5">Apply Now</a>
								<!--end::Apply-->
							</div>
							<!--end::Job-->
							<!--begin::Job-->
							...
							<div class="card bg-light">
								...
								<div class="card-body">
									...
									<div class="mb-7">
										...
										<!--end::Title-->
										<!--begin::Text-->
										<p class="fw-semibold fs-6 text-gray-600">First, a disclaimer – the entire process of writing a blog
											post often takes more than a couple of hours, even if you can type eighty words as per minute and
											your writing skills are sharp.</p>
										<!--end::Text-->
									</div>
									<!--end::Top-->
									...
									<!--end::Item-->
									<!--begin::Link-->
									<a href="../../demo6/dist/pages/blog/post.html" class="link-primary fs-6 fw-semibold">Explore More</a>
									<!--end::Link-->
								</div>
								<!--end::Body-->
							</div>
