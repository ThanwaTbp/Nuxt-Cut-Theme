				...
				<div class="card-body">
						...
						<div class="d-flex flex-stack flex-grow-1">
							...
							<div class="fw-semibold">
								...
								<div class="fs-6 text-gray-700">Your payment was declined. To start using tools, please
									<a href="#" class="fw-bold" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">Add Payment
										Method</a>.
								</div>
							</div>
							<!--end::Content-->
					...
					<div class="row">
						...
						<div class="col-lg-7">
							...
							<p class="fs-6 text-gray-600 fw-semibold mb-6 mb-lg-15">We will send you a notification upon Subscription
								expiration</p>
							<!--end::Heading-->
							<!--begin::Info-->
							<div class="fs-5 mb-2">
							...
							<div class="col-xl-6" data-kt-billing-element="card">
								...
								<div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
									...
									<div class="d-flex flex-column py-2">
										...
										<div class="d-flex align-items-center">
											<!--begin::Icon-->
											<img src="/media/svg/card-logos/visa.svg" alt="" class="me-4" />
											<!--end::Icon-->
											<!--begin::Details-->
											<div>
							...
							<div class="col-xl-6" data-kt-billing-element="card">
								...
								<div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
									...
									<div class="d-flex flex-column py-2">
										...
										<div class="d-flex align-items-center">
											<!--begin::Icon-->
											<img src="/media/svg/card-logos/american-express.svg" alt="" class="me-4" />
											<!--end::Icon-->
											<!--begin::Details-->
											<div>
							...
							<div class="col-xl-6" data-kt-billing-element="card">
								...
								<div class="card card-dashed h-xl-100 flex-row flex-stack flex-wrap p-6">
									...
									<div class="d-flex flex-column py-2">
										...
										<div class="d-flex align-items-center">
											<!--begin::Icon-->
											<img src="/media/svg/card-logos/mastercard.svg" alt="" class="me-4" />
											<!--end::Icon-->
											<!--begin::Details-->
											<div>
					...
					<div id="kt_billing_paypal" class="tab-pane fade" role="tabpanel" aria-labelledby="kt_billing_paypal_tab">
						...
						<form class="form">
							...
							<div class="mb-7 mw-350px">
								<select name="timezone" data-control="select2" data-placeholder="Select an option" data-hide-search="true"
							...
							<div
								...
								<div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
									...
									<div class="mb-3 mb-md-0 fw-semibold">
										...
										<div class="fs-6 text-gray-700 pe-7">Writing headlines for blog posts is much science and probably
											cool audience</div>
									</div>
									<!--end::Content-->
									<!--begin::Action-->
