									...
									<div class="carousel-item active">
										...
										<div class="carousel-wrapper">
											...
											<div class="d-flex flex-column flex-grow-1">
												...
												<p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">In the last year, you’ve probably had to adapt
													to new ways of living and working.</p>
											</div>
											<!--end::Description-->
											<!--begin::Summary-->
									...
									<div class="carousel-item">
										...
										<div class="carousel-wrapper">
											...
											<div class="d-flex flex-column flex-grow-1">
												...
												<p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">As we approach one year of working remotely,
													we wanted to take a look back and share some ways teams around the world have collaborated
													effectively.</p>
											</div>
											<!--end::Description-->
											<!--begin::Summary-->
									...
									<div class="carousel-item">
										...
										<div class="carousel-wrapper">
											...
											<div class="d-flex flex-column flex-grow-1">
												...
												<p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">Today we are excited to share an amazing
													certification opportunity which is designed to teach you everything</p>
											</div>
											<!--end::Description-->
											<!--begin::Summary-->
											<div class="d-flex flex-stack pt-8">
