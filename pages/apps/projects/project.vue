			...
			<div class="card mb-6 mb-xl-9">
				<div class="card-body pt-9 pb-0">
					...
					<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
						<!--begin::Nav item-->
						<li class="nav-item">
							<NuxtLink class="nav-link text-active-primary py-5 me-6 active"
								to="/apps/projects/project">Overview</NuxtLink>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
							<NuxtLink class="nav-link text-active-primary py-5 me-6"
								to="/apps/projects/targets">Targets</NuxtLink>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
							<NuxtLink class="nav-link text-active-primary py-5 me-6"
								to="/apps/projects/budget">Budget</NuxtLink>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
							<NuxtLink class="nav-link text-active-primary py-5 me-6" to="/apps/projects/users">Users</NuxtLink>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
							<NuxtLink class="nav-link text-active-primary py-5 me-6" to="/apps/projects/files">Files</NuxtLink>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
							<NuxtLink class="nav-link text-active-primary py-5 me-6"
								to="/apps/projects/activity">Activity</NuxtLink>
						</li>
						<!--end::Nav item-->
						<!--begin::Nav item-->
						<li class="nav-item">
							<NuxtLink class="nav-link text-active-primary py-5 me-6"
								to="/apps/projects/settings">Settings</NuxtLink>
						</li>
						<!--end::Nav item-->
					</ul>
					<!--end::Nav-->
								...
								<div class="d-flex flex-stack flex-grow-1">
									...
									<div class="fw-semibold">
										<div class="fs-6 text-gray-700">
											<a href="#" class="fw-bold me-1">Invite New .NET Collaborators</a>to create great outstanding
								...
								<div id="kt_schedule_day_1" class="tab-pane fade show active">
									...
									<div class="d-flex flex-stack position-relative mt-8">
										...
										<div class="fw-semibold ms-5 text-gray-600">
											...
											<!--end::Time-->
											<!--begin::Title-->
											<a href="#" class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">9 Degree Project Estimation
												Meeting</a>
											<!--end::Title-->
											<!--begin::User-->
											<div class="text-gray-400">Lead by
											...
											<div class="mb-10">
												...
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true"
														data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea1ed04"
									...
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true"
														data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea21f2e"
														data-allow-clear="true">
														<option></option>
														<option value="1">Approved</option>
														<option value="2">Pending</option>
									...
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true"
														data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea2556a"
														data-allow-clear="true">
														<option></option>
														<option value="1">Approved</option>
														<option value="2">Pending</option>
									...
									<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
										...
										<div class="px-7 py-5">
											...
											<div class="mb-10">
												...
												<div>
													<select class="form-select form-select-solid" data-kt-select2="true"
														data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea278d0"
														data-allow-clear="true">
														<option></option>
														<option value="1">Approved</option>
														<option value="2">Pending</option>
					...
					<div class="card card-flush h-lg-100">
						...
						<div class="card-body d-flex flex-column mb-9 p-9 pt-3">
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea324f8"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
							...
							<div class="d-flex align-items-center position-relative mb-7">
								...
								<!--begin::Details-->
								<div class="fw-semibold">
									<a href="#" class="fs-6 fw-bold text-gray-900 text-hover-primary">Schedule a meeting with FireBear CTO
										John</a>
									<!--begin::Info-->
									<div class="text-gray-400">Due in 3 days
										<a href="#">Rober Doe</a>
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea343f2"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea36027"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea38803"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
								...
								<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
									...
									<div class="px-7 py-5">
										...
										<div class="mb-10">
											...
											<div>
												<select class="form-select form-select-solid" data-kt-select2="true"
													data-placeholder="Select option" data-dropdown-parent="#kt_menu_637deeea3aa51"
													data-allow-clear="true">
													<option></option>
													<option value="1">Approved</option>
													<option value="2">Pending</option>
				...
				<div class="card-header mt-5">
					...
					<div class="card-toolbar my-1">
						...
						<div class="d-flex align-items-center position-relative my-1">
							...
							<!--end::Svg Icon-->
							<input type="text" id="kt_filter_search" class="form-control form-control-solid form-select-sm w-150px ps-9"
