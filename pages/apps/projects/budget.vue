							...
							<div class="col-xl-9">
								...
								<div class="d-flex flex-column">
									...
									<div class="h-8px bg-light rounded mb-3">
										<div class="bg-success rounded h-8px" role="progressbar" style="width: 68%;" aria-valuenow="50"
									...
									<div class="col-md-4 col-lg-12 col-xxl-4">
										<label
											...
											<span class="ms-5">
												...
												<span class="fw-semibold fs-7 text-gray-600">Withdraw money to your bank account per transaction
							...
							<div class="col-xl-9">
								...
								<div class="position-relative w-md-300px" data-kt-dialer="true" data-kt-dialer-min="1000"
									...
									<input type="text" class="form-control form-control-solid border-0 ps-12" data-kt-dialer-control="input"
										placeholder="Amount" name="manageBudget" readonly="readonly" value="$36,000.00" />
									<!--end::Input control-->
