				...
				<div class="timeline-content mb-10 mt-n1">
					...
					<div class="overflow-auto pb-5">
						...
						<div
							...
							<!--begin::Title-->
							<NuxtLink to="/apps/projects/project"
								class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</NuxtLink>
							<!--end::Title-->
							<!--begin::Label-->
							...
							<!--begin::Action-->
							<NuxtLink to="/apps/projects/project"
								class="btn btn-sm btn-light btn-active-light-primary">View</NuxtLink>
							<!--end::Action-->
						</div>
						<!--end::Record-->
						<!--begin::Record-->
						<div
							...
							<!--begin::Title-->
							<NuxtLink to="/apps/projects/project"
								class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</NuxtLink>
							<!--end::Title-->
							<!--begin::Label-->
						...
						<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
							...
							<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
								...
								<div class="ms-1 fw-semibold">
									<!--begin::Desc-->
									<NuxtLink to="/apps/projects/project" class="fs-6 text-hover-primary fw-bold">Finance
										KPI App Guidelines</NuxtLink>
									<!--end::Desc-->
									<!--begin::Number-->
				...
				<div class="timeline-content mb-10 mt-n1">
					...
					<div class="pe-3 mb-5">
						...
						<div class="fs-5 fw-semibold mb-2">New case
							<a href="#" class="text-primary fw-bold me-1">#67890</a>is assigned to you in Multi-platform Database Design
							project
						</div>
						<!--end::Title-->
						<!--begin::Description-->
						...
						<div
							...
							<div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
								...
								<div class="mb-3 mb-md-0 fw-semibold">
									...
									<div class="fs-6 text-gray-700 pe-7">Login into Admin Dashboard to make sure the data integrity is OK
									</div>
								</div>
								<!--end::Content-->
								<!--begin::Action-->
