				...
				<div class="card-header pt-8">
					...
					<div class="card-toolbar">
						...
						<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
							...
							<NuxtLink to="/apps/file-manager/folders" class="btn btn-icon btn-light-primary me-3">
					...
					<div class="d-flex flex-stack">
						...
						<div class="badge badge-lg badge-light-primary">
							<div class="d-flex align-items-center flex-wrap">
								...
								<!--end::Svg Icon-->
								<NuxtLink to="/apps/file-manager/folders">Keenthemes</NuxtLink>
								...
								<!--end::Svg Icon-->
								<NuxtLink to="/apps/file-manager/folders">themes</NuxtLink>
								<!--begin::Svg Icon | path: icons/duotune/arrows/arr071.svg-->
								<span class="svg-icon svg-icon-2 svg-icon-primary mx-1">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
								...
								<!--end::Svg Icon-->
								<NuxtLink to="/apps/file-manager/folders"></NuxtLink>
								<!--begin::Svg Icon | path: icons/duotune/arrows/arr071.svg-->
								<span class="svg-icon svg-icon-2 svg-icon-primary mx-1">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
