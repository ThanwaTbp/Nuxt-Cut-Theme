	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div id="kt_content_container" class="container-xxl">
			...
			<div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-10"
				style="background-size: auto calc(100% + 10rem); background-position-x: 100%; background-image: url('/media/illustrations/sketchy-1/4.png')">
				<!--begin::Card header-->
				...
				<div class="card-header pt-8">
					...
					<div class="card-toolbar">
						...
						<div class="d-flex justify-content-end align-items-center d-none"
							...
							<button type="button" class="btn btn-danger" data-kt-filemanager-table-select="delete_selected">Delete
								Selected</button>
						</div>
						<!--end::Group actions-->
					</div>
							...
							<tr>
								...
								<td data-order="account">
									<div class="d-flex align-items-center">
										...
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">account</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
								...
								<td class="text-end" data-kt-filemanager-table="action_dropdown">
									<div class="d-flex justify-content-end">
													...
													<div class="card-body p-5">
														...
														<div class="d-flex flex-column text-start d-none" data-kt-filemanger-table="copy_link_result">
															...
															<div class="text-muted fw-normal mt-2 fs-8 px-3">Read only.
																<NuxtLink to="/apps/file-manager/settings" class="ms-2">Change
										...
										<!--begin::More-->
										<div class="ms-2">
											<button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary me-2"
												data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
											...
											<div
												...
												<div class="menu-item px-3">
													<NuxtLink to="/apps/file-manager/files" class="menu-link px-3">View</NuxtLink>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
							...
							<tr>
								...
								<td data-order="apps">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">apps</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="widgets">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">widgets</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary"></NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="documentation">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">documentation</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="layouts">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">layouts</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="modals">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">modals</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="authentication">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">authentication</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="dashboards">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">dashboards</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="media">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">media</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="customers">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">customers</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="user-management">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">user-management</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="subscriptions">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">subscriptions</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="forms">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">forms</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="buttons">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">buttons</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="datatables">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">datatables</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="index">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">index</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<tr>
								...
								<td data-order="landing">
									<div class="d-flex align-items-center">
										...
										<!--end::Svg Icon-->
										<NuxtLink to="/apps/file-manager/files"
											class="text-gray-800 text-hover-primary">landing</NuxtLink>
									</div>
								</td>
								<!--end::Name=-->
								<!--begin::Size-->
							...
							<div class="card card-flush">
								<div class="card-body p-5">
									...
									<div class="d-flex flex-column text-start d-none" data-kt-filemanger-table="copy_link_result">
										...
										<div class="text-muted fw-normal mt-2 fs-8 px-3">Read only.
											<NuxtLink to="/apps/file-manager/settings" class="ms-2">Change permissions</NuxtLink>
										</div>
									</div>
									<!--end::Link-->
								</div>
