					...
					<div class="tab-content" id="myTabContent">
									...
									<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
										...
										<tbody class="fs-6 fw-semibold text-gray-600">
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">1935-3834</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
												...
												<td class="pe-0 text-end">
													...
													<div
														...
														<!--begin::Menu item-->
														<div class="menu-item px-3">
															<NuxtLink to="/apps/customers/view" class="menu-link px-3">View</NuxtLink>
														</div>
														<!--end::Menu item-->
														<!--begin::Menu item-->
														<div class="menu-item px-3">
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">5020-6883</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">9203-5269</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">6009-4561</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">4590-7987</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">9347-2818</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">2160-5686</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">9058-8365</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
											...
											<tr>
												<!--begin::Invoice=-->
												<td>
													<a href="#" class="text-gray-600 text-hover-primary mb-1">5867-1243</a>
												</td>
												<!--end::Invoice=-->
												<!--begin::Status=-->
												<td>
									...
									<div class="py-0" data-kt-customer-payment-method="row">
										...
										<div class="py-3 d-flex flex-stack flex-wrap">
											...
											<div class="d-flex my-3 ms-9">
												...
												<!--end::Delete-->
												<!--begin::More-->
												<a href="#" class="btn btn-icon btn-active-light-primary w-30px h-30px" data-bs-toggle="tooltip"
													title="More Options" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
												...
												<div class="flex-equal me-5">
													<table class="table table-flush fw-semibold gy-1">
														...
														<tr>
															...
															<td class="text-gray-800">**** 3658</td>
														</tr>
														<tr>
									...
									<div class="py-0" data-kt-customer-payment-method="row">
										...
										<div class="py-3 d-flex flex-stack flex-wrap">
											...
											<div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse"
												...
												<!--end::Arrow-->
												<!--begin::Logo-->
												<img src="/media/svg/card-logos/visa.svg" class="w-40px me-3" alt="" />
												<!--end::Logo-->
												<!--begin::Summary-->
												<div class="me-3">
													<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-wrap py-5">
												...
												<div class="flex-equal me-5">
													<table class="table table-flush fw-semibold gy-1">
														...
														<tr>
															<td class="text-muted min-w-125px w-125px">Number</td>
															<td class="text-gray-800">**** 2893</td>
														</tr>
														<tr>
															<td class="text-muted min-w-125px w-125px">Expires</td>
									...
									<div class="py-0" data-kt-customer-payment-method="row">
										...
										<div class="py-3 d-flex flex-stack flex-wrap">
											...
											<div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse"
												...
												<!--end::Arrow-->
												<!--begin::Logo-->
												<img src="/media/svg/card-logos/american-express.svg" class="w-40px me-3" alt="" />
												<!--end::Logo-->
												<!--begin::Summary-->
												<div class="me-3">
													<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-wrap py-5">
												...
												<div class="flex-equal me-5">
													<table class="table table-flush fw-semibold gy-1">
														...
														<tr>
															<td class="text-muted min-w-125px w-125px">Number</td>
															<td class="text-gray-800">**** 2646</td>
														</tr>
														<tr>
															<td class="text-muted min-w-125px w-125px">Expires</td>
							...
							<div class="card pt-4 mb-6 mb-xl-9">
								...
								<div class="card-body pt-0">
									<div class="fw-bold fs-2">$32,487.57
										...
										<div class="fs-7 fw-normal text-muted">Balance will increase the amount due on the customer's next
											invoice.</div>
									</div>
								</div>
								<!--end::Card body-->
										...
										<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5"
											...
											<tbody>
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td>POST /v1/customer/c_637df0399ec2d/not_found</td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td>POST /v1/invoices/in_3088_7107/payment</td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td>POST /v1/invoice/in_5835_8644/invalid</td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
													<td class="pe-0 text-end min-w-200px">15 Apr 2022, 6:43 am</td>
													<!--end::Timestamp=-->
												</tr>
												<!--end::Table row-->
												<!--begin::Table row-->
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td>POST /v1/invoice/in_6772_9222/invalid</td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
													<td class="pe-0 text-end min-w-200px">25 Oct 2022, 5:30 pm</td>
													<!--end::Timestamp=-->
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td>POST /v1/invoices/in_7932_7546/payment</td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td>POST /v1/customer/c_637df0399ec20/not_found</td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td>POST /v1/invoices/in_7045_3949/payment</td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
												...
												<tr>
													...
													<!--end::Badge=-->
													<!--begin::Status=-->
													<td>POST /v1/invoices/in_4672_5159/payment</td>
													<!--end::Status=-->
													<!--begin::Timestamp=-->
										...
										<tbody>
											...
											<tr>
												...
												<td class="min-w-400px">Invoice
													<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#SEP-45656</a>status has
													changed from
												...
												<!--end::Event=-->
												<!--begin::Timestamp=-->
												<td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2022, 11:05 am</td>
												<!--end::Timestamp=-->
											</tr>
											<!--end::Table row-->
											<!--begin::Table row-->
											<tr>
												<!--begin::Event=-->
												<td class="min-w-400px">Invoice
													<a href="#" class="fw-bold text-gray-900 text-hover-primary me-1">#DER-45645</a>status has
													changed from
												...
												<!--end::Event=-->
												<!--begin::Timestamp=-->
												<td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2022, 5:30 pm</td>
												<!--end::Timestamp=-->
											</tr>
											<!--end::Table row-->
											<!--begin::Table row-->
						...
						<div class="tab-pane fade" id="kt_customer_view_overview_statements" role="tabpanel">
							...
							<div class="card mb-6 mb-xl-9">
								...
								<!--begin::Body-->
								<div class="card-body py-0">
									<div class="fs-5 fw-semibold text-gray-500 mb-4">Last 30 day earnings calculated. Apart from arranging
										the order of topics.</div>
									<!--begin::Left Section-->
						...
						<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
							...
							<form id="kt_modal_add_payment_form" class="form" action="#">
								...
								<div class="fv-row mb-7">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<select class="form-select form-select-solid fw-bold" name="status" data-control="select2"
						...
						<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
							...
							<form id="kt_modal_adjust_balance_form" class="form" action="#">
								...
								<div class="fv-row mb-7">
									...
									<!--end::Label-->
									<!--begin::Dropdown-->
									<select class="form-select form-select-solid fw-bold" name="adjustment" aria-label="Select an option"
										data-control="select2" data-dropdown-parent="#kt_modal_adjust_balance"
										data-placeholder="Select an option" data-hide-search="true">
										<option></option>
								...
								<div class="fv-row mb-7">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input id="kt_modal_inputmask" type="text" class="form-control form-control-solid" name="amount"
										value="" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								...
								<!--end::Input group-->
								<!--begin::Disclaimer-->
								<div class="fs-7 text-muted mb-15">Please be aware that all manual balance changes will be audited by the
									financial team every fortnight. Please maintain your invoices and receipts until then. Thank you.</div>
								<!--end::Disclaimer-->
								<!--begin::Actions-->
								<div class="text-center">
								...
								<div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_customer_scroll"
									...
									<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
										...
										<div class="d-flex flex-stack flex-grow-1">
											<!--begin::Content-->
											<div class="fw-semibold">
												<div class="fs-6 text-gray-700">Updating customer details will receive a privacy audit. For more
										...
										<div class="mb-7">
											...
											<div class="mt-1">
												...
												<div class="image-input image-input-outline" data-kt-image-input="true"
													style="background-image: url('/media/svg/avatars/blank.svg')">
									...
									<div id="kt_modal_update_customer_billing_info" class="collapse">
										...
										<div class="d-flex flex-column mb-7 fv-row">
											...
											<select name="country" aria-label="Select a Country" data-control="select2"
												data-placeholder="Select a Country..." data-dropdown-parent="#kt_modal_update_customer"
