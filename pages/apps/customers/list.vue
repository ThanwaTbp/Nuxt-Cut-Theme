					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
						...
						<tbody class="fw-semibold text-gray-600">
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Emma
										Smith</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<td data-filter="mastercard">
									<img src="/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 1782
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Melody
										Macy</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<!--begin::Payment method=-->
								<td data-filter="visa">
									<img src="/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 9759
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Max
										Smith</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<!--begin::Payment method=-->
								<td data-filter="mastercard">
									<img src="/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8832
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Sean
										Bean</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<td data-filter="american_express">
									<img src="/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 1294
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Brian
										Cox</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<!--begin::Payment method=-->
								<td data-filter="visa">
									<img src="/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 3207
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/customers/view"
										class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
								...
								<!--begin::Payment method=-->
								<td data-filter="american_express">
									<img src="/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 1234
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/customers/view"
										class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
								...
								<!--begin::Payment method=-->
								<td data-filter="mastercard">
									<img src="/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3663
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Olivia
										Wild</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<!--begin::Payment method=-->
								<td data-filter="american_express">
									<img src="/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 9549
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Neil
										Owen</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<!--begin::Payment method=-->
								<td data-filter="visa">
									<img src="/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 9917
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Dan
										Wilson</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<!--begin::Payment method=-->
								<td data-filter="visa">
									<img src="/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 1707
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Payment method=-->
								<td data-filter="mastercard">
									<img src="/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3536
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
							...
							<tr>
								...
								<!--begin::Name=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Ana
										Crown</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								...
								<!--begin::Payment method=-->
								<td data-filter="american_express">
									<img src="/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 6307
								</td>
								<!--end::Payment method=-->
								<!--begin::Date=-->
				...
				<div class="modal-dialog modal-dialog-centered mw-650px">
					...
					<div class="modal-content">
						...
						<form class="form" action="#" id="kt_modal_add_customer_form"
							data-kt-redirect="../../demo6/dist/apps/customers/list">
							<!--begin::Modal header-->
