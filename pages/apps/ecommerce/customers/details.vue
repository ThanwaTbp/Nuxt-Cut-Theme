					...
					<div class="card mb-5 mb-xl-8">
						...
						<div class="card-body pt-15">
							...
							<div class="pb-5 fs-6">
								...
								<div class="text-gray-600">
									<NuxtLink to="/apps/ecommerce/sales/details"
										class="text-gray-600 text-hover-primary">#14534</NuxtLink>
								</div>
								<!--begin::Details item-->
							</div>
							<!--end::Details content-->
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#15062</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#14341</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#15854</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#15333</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#15632</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#15954</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#15086</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#15760</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<td>
	<NuxtLink to="/apps/ecommerce/sales/details"
		class="text-gray-600 text-hover-primary mb-1">#15332</NuxtLink>
</td>
<!--end::order=-->
<!--begin::Status=-->
<td>
...
<div class="fv-row mb-7">
	...
	<!--end::Label-->
	<!--begin::Input-->
	<input type="email" class="form-control form-control-solid" placeholder="" name="gen_email"
		value="max@kt.com" />
	<!--end::Input-->
</div>
<!--end::Input group-->
...
<div class="fv-row mb-7">
	...
	<!--end::Label-->
	<!--begin::Input-->
	<input type="email" class="form-control form-control-solid" placeholder="" name="bill_email"
...
<!--begin::Menu-->
<div
	class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold w-200px py-3"
	data-kt-menu="true">
	<!--begin::Menu item-->
	<div class="menu-item px-3">
		<a href="#" class="menu-link px-3" data-kt-payment-mehtod-action="set_as_default">Set as
			default address</a>
	</div>
	<!--end::Menu item-->
</div>
...
<div class="flex-equal me-5">
	<table class="table table-flush fw-semibold gy-1">
		...
		<tr>
			...
			<td class="text-gray-800">**** 3361</td>
		</tr>
		<tr>
...
<div class="flex-equal me-5">
	<table class="table table-flush fw-semibold gy-1">
		...
		<tr>
			<td class="text-muted min-w-125px w-125px">Number</td>
			<td class="text-gray-800">**** 9331</td>
		</tr>
		<tr>
			<td class="text-muted min-w-125px w-125px">Expires</td>
...
<div class="flex-equal me-5">
	<table class="table table-flush fw-semibold gy-1">
		...
		<tr>
			<td class="text-muted min-w-125px w-125px">Number</td>
			<td class="text-gray-800">**** 1498</td>
		</tr>
		<tr>
			<td class="text-muted min-w-125px w-125px">Expires</td>
...
data-placeholder="Select a Country..." data-dropdown-parent="#kt_modal_update_address"
								...
								<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
									...
									<div class="d-flex flex-stack flex-grow-1">
										...
										<div class="fw-semibold">
											<div class="fs-6 text-gray-700">Please note that a valid phone number may be required for order or
shipping rescheduling.</div>
										</div>
										<!--end::Content-->
									</div>
									<!--end::Wrapper-->
						...
						<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
							...
							<div class="fw-bold d-flex flex-column justify-content-center mb-5">
								...
								<div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
									<img src="/media/misc/qr.png" alt="Scan this QR code" />
								</div>
								<!--end::QR code-->
								<!--begin::Text code-->
							...
							<div class="d-flex flex-center">
								...
								<div class="btn btn-light-primary d-none" data-kt-add-auth-action="qr-code-button">Scan barcode instead
								</div>
							</div>
							<!--end::Action-->
						</div>
						...
						<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
							...
							<form class="form" id="kt_modal_add_one_time_password_form">
								...
								<div class="fv-row mb-7">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="email" class="form-control form-control-solid" name="otp_email" value="smith@kpmg.com"
										readonly="readonly" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
