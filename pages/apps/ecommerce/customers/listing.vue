					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
						...
						<tbody class="fw-semibold text-gray-600">
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Emma Smith</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Melody Macy</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Max Smith</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Sean Bean</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Brian Cox</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Olivia Wild</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Neil Owen</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Dan Wilson</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Emma Bold</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Ana Crown</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Robert Doe</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">John Miller</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
							...
							<tr>
								...
								<td>
									<NuxtLink to="/apps/ecommerce/customers/details"
										class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</NuxtLink>
								</td>
								<!--end::Name=-->
								<!--begin::Email=-->
								<td>
