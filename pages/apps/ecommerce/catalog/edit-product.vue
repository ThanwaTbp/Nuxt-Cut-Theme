	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div id="kt_content_container" class="container-xxl">
			...
			<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
				data-kt-redirect="../../demo6/dist/apps/ecommerce/catalog/products">
				<!--begin::Aside column-->
				<div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
						...
						<div class="card-body text-center pt-0">
							...
							<div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
								...
								<div class="image-input-wrapper w-150px h-150px"
									style="background-image: url(/media//stock/ecommerce/78.gif)"></div>
					...
					<div class="card card-flush py-4">
						...
						<div class="card-body pt-0">
							...
							<!--end::Input group-->
							<!--begin::Button-->
							<NuxtLink to="/apps/ecommerce/catalog/add-category"
								...
								<!--end::Svg Icon-->Create new category</NuxtLink>
							<!--end::Button-->
							<!--begin::Input group-->
							<!--begin::Label-->
				...
				<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
								...
								<div class="card card-flush py-4">
									...
									<div class="card-body pt-0">
										...
										<div class="fv-row">
											...
											<!--end::Input-->
											<!--begin::Description-->
											<div class="text-muted fs-7">Set if the product is a physical or digital item. Physical products may
								...
								<div class="card card-flush py-4">
									...
									<div class="card-body pt-0">
										...
										<div>
											...
											<!--end::Editor-->
											<!--begin::Description-->
											<div class="text-muted fs-7">Set a list of keywords that the product is related to. Separate the
										...
										<table class="table table-row-dashed fs-6 gy-5 my-0" id="kt_ecommerce_add_product_reviews">
											...
											<tbody>
														...
														<NuxtLink to="/apps/inbox/reply"
															...
															<div class="symbol symbol-circle symbol-25px me-3">
																<span class="symbol-label"
																	style="background-image:url(/media/avatars/300-1.jpg)"></span>
															</div>
															<!--end::Avatar-->
															<!--begin::Name-->
												...
												<tr>
													...
													<td>
														<NuxtLink to="/apps/inbox/reply"
															...
															<div class="symbol symbol-circle symbol-25px me-3">
																<span class="symbol-label"
																	style="background-image:url(/media/avatars/300-5.jpg)"></span>
															</div>
															<!--end::Avatar-->
															<!--begin::Name-->
													...
													<td class="text-gray-600 fw-bold">Awesome quality with great materials used, but could be more
														comfortable</td>
													<td class="text-end">
												...
												<tr>
													...
													<td>
														<NuxtLink to="/apps/inbox/reply"
															...
															<div class="symbol symbol-circle symbol-25px me-3">
																<span class="symbol-label"
																	style="background-image:url(/media/avatars/300-25.jpg)"></span>
															</div>
															<!--end::Avatar-->
															<!--begin::Name-->
												...
												<tr>
													...
													<td>
														<NuxtLink to="/apps/inbox/reply"
															...
															<div class="symbol symbol-circle symbol-25px me-3">
																<span class="symbol-label"
																	style="background-image:url(/media/avatars/300-9.jpg)"></span>
															</div>
															<!--end::Avatar-->
															<!--begin::Name-->
												...
												<tr>
													...
													<td class="text-gray-600 fw-bold">Excellent quality, I got it for my son's birthday and he loved
														it!</td>
													<td class="text-end">
												...
												<tr>
													...
													<td>
														<NuxtLink to="/apps/inbox/reply"
															...
															<div class="symbol symbol-circle symbol-25px me-3">
																<span class="symbol-label"
																	style="background-image:url(/media/avatars/300-23.jpg)"></span>
															</div>
															<!--end::Avatar-->
															<!--begin::Name-->
													...
													<td class="text-gray-600 fw-bold">I got this for Christmas last year, and it's still the best
												...
												<tr>
													...
													<td class="text-gray-600 fw-bold">Was skeptical at first, but after using it for 3 months, I'm
												...
												<tr>
													...
													<td>
														<NuxtLink to="/apps/inbox/reply"
															...
															<div class="symbol symbol-circle symbol-25px me-3">
																<span class="symbol-label"
																	style="background-image:url(/media/avatars/300-12.jpg)"></span>
															</div>
															<!--end::Avatar-->
															<!--begin::Name-->
												...
												<tr>
													...
													<td>
														<NuxtLink to="/apps/inbox/reply"
															...
															<div class="symbol symbol-circle symbol-25px me-3">
																<span class="symbol-label"
																	style="background-image:url(/media/avatars/300-13.jpg)"></span>
															</div>
															<!--end::Avatar-->
															<!--begin::Name-->
					...
					<div class="d-flex justify-content-end">
						<!--begin::Button-->
						<NuxtLink to="/apps/ecommerce/catalog/products" id="kt_ecommerce_add_product_cancel"
