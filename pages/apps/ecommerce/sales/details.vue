		...
		<div id="kt_content_container" class="container-xxl">
			...
			<div class="d-flex flex-column gap-7 gap-lg-10">
				<div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
					...
					<!--end:::Tabs-->
					<!--begin::Button-->
					<NuxtLink to="/apps/ecommerce/sales/listing"
					...
					<!--end::Button-->
					<!--begin::Button-->
					<NuxtLink to="/apps/ecommerce/sales/edit-order" class="btn btn-success btn-sm me-lg-n7">Edit
						Order</NuxtLink>
					<!--end::Button-->
					<!--begin::Button-->
					<NuxtLink to="/apps/ecommerce/sales/add-order" class="btn btn-primary btn-sm">Add New Order</NuxtLink>
					<!--end::Button-->
				</div>
				<!--begin::Order summary-->
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr>
											...
											<td class="fw-bold text-end">Online
												<img src="/media/svg/card-logos/visa.svg" class="w-50px ms-2" />
											</td>
										</tr>
										<!--end::Payment method-->
										<!--begin::Date-->
								...
								<table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr>
											...
											<td class="fw-bold text-end">
												<div class="d-flex align-items-center justify-content-end">
													...
													<!--begin::Name-->
													<NuxtLink to="/apps/ecommerce/customers/details"
														class="text-gray-600 text-hover-primary">Dan Wilson</NuxtLink>
													<!--end::Name-->
												</div>
											</td>
										</tr>
										...
										<tr>
											...
											<td class="fw-bold text-end">
												<NuxtLink to="/apps/user-management/users/view"
													class="text-gray-600 text-hover-primary">dam@consilting.com</NuxtLink>
											</td>
										</tr>
										<!--end::Payment method-->
										<!--begin::Date-->
								...
								<table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
									...
									<tbody class="fw-semibold text-gray-600">
										...
										<tr>
											...
											<td class="fw-bold text-end">
												<NuxtLink to="/apps/invoices/view/invoice-3"
													class="text-gray-600 text-hover-primary">#INV-000414</NuxtLink>
											</td>
										</tr>
										<!--end::Invoice-->
										<!--begin::Shipping-->
												...
												<tr>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<div class="ms-5">
																<NuxtLink to="/apps/ecommerce/catalog/edit-product"
																	class="fw-bold text-gray-600 text-hover-primary">Product 1</NuxtLink>
													...
													<td>
														<div class="d-flex align-items-center">
															...
															<NuxtLink to="/apps/ecommerce/catalog/edit-product"
																class="symbol symbol-50px">
																<span class="symbol-label"
																	style="background-image:url(/media//stock/ecommerce/100.gif);"></span>
															</NuxtLink>
															<!--end::Thumbnail-->
															<!--begin::Title-->
															<div class="ms-5">
																<NuxtLink to="/apps/ecommerce/catalog/edit-product"
																	class="fw-bold text-gray-600 text-hover-primary">Footwear</NuxtLink>
																<div class="fs-7 text-muted">Delivery Date: 23/11/2022</div>
															</div>
															<!--end::Title-->
														</div>
										...
										<table class="table align-middle table-row-bordered mb-0 fs-6 gy-5">
											...
											<tbody class="fw-semibold text-gray-600">
												...
												<tr>
													...
													<td class="fw-bold text-end">Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36
														(, like Gecko) Chrome/96.0.4664.110 Safari/537.36</td>
												</tr>
												<!--end::User agent-->
