								...
								<div class="d-flex flex-column align-items-start flex-xxl-row">
									...
									<div class="d-flex align-items-center flex-equal fw-row me-4 order-2" data-bs-toggle="tooltip"
										...
										<div class="position-relative d-flex align-items-center w-150px">
											<!--begin::Datepicker-->
											<input class="form-control form-control-transparent fw-bold pe-5" placeholder="Select date"
												name="invoice_date" />
											<!--end::Datepicker-->
											<!--begin::Icon-->
										...
										<table class="table g-5 gs-0 mb-0 fw-bold text-gray-700" data-kt-element="items">
											...
											<tbody>
												<tr class="border-bottom border-bottom-dashed" data-kt-element="item">
													...
													<td class="ps-0">
														<input class="form-control form-control-solid" type="number" min="1" name="quantity[]"
												...
												<tr class="border-top border-top-dashed align-top fs-6 fw-bold text-gray-700">
													...
													<th colspan="2" class="border-bottom border-bottom-dashed ps-0">
														<div class="d-flex flex-column align-items-start">
															...
															<button class="btn btn-link py-1" data-bs-toggle="tooltip" data-bs-trigger="hover"
