						...
						<div class="card-body pt-5">
							...
							<div class="d-flex flex-column gap-5">
								...
								<div class="d-flex flex-stack">
									<NuxtLink to="/apps/contacts/getting-started.html"
							...
							<NuxtLink to="/apps/contacts/add-contact.html" class="btn btn-primary w-100">
							...
							<div class="scroll-y me-n5 pe-5 h-300px h-xl-auto" data-kt-scroll="true"
								...
								<div class="d-flex flex-stack py-4">
									...
									<div class="d-flex align-items-center">
										...
										<!--begin::Details-->
										<div class="ms-4">
											<NuxtLink to="/apps/contacts/view-contact.html"
					...
					<div class="card card-flush h-lg-100" id="kt_contacts_main">
						...
						<div class="card-header pt-7" id="kt_chat_contacts_header">
							...
							<div class="card-toolbar gap-3">
								...
								<!--end::Chat-->
								<!--begin::Chat-->
								<NuxtLink to="/apps/inbox/reply.html" class="btn btn-sm btn-light btn-active-light-primary">
								...
								<div
									...
									<div class="menu-item px-3">
										<NuxtLink to="/apps/contacts/edit-contact.html" class="menu-link px-3">Edit</NuxtLink>
									</div>
									<!--end::Menu item-->
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<a href="#" class="menu-link px-3" id="kt_contact_delete"
											data-kt-redirect="../../demo6/dist/apps/contacts/getting-started.html">Delete</a>
									</div>
									<!--end::Menu item-->
								</div>
								<!--end::Menu-->
						...
						<div class="card-body pt-5">
							...
							<div class="d-flex gap-7 align-items-center">
								...
								<div class="symbol symbol-circle symbol-100px">
									<img src="/media/avatars/300-6.jpg" alt="image" />
								</div>
								<!--end::Avatar-->
								...
								<div class="tab-pane fade show active" id="kt_contact_view_general" role="tabpanel">
									...
									<div class="d-flex flex-column gap-5 mt-7">
										...
										<div class="d-flex flex-column gap-1">
											...
											<p>Emma Smith joined the team on September 2019 as a junior associate. She soon showcased her
												expertise and experience in knowledge and skill in the field, which was very valuable to the
												company. She was promptly promoted to senior associate on July 2020.
												<br />
										...
										<div id="kt_schedule_day_0" class="tab-pane fade show">
											...
											<div class="d-flex flex-stack position-relative mt-8">
												...
												<div class="fw-semibold ms-5 text-gray-600">
													...
													<!--end::Time-->
													<!--begin::Title-->
													<a href="#" class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">Development Team Capacity
														Review</a>
													<!--end::Title-->
													<!--begin::User-->
													<div class="text-gray-400">Lead by
											...
											<div class="d-flex flex-stack position-relative mt-8">
												...
												<div class="fw-semibold ms-5 text-gray-600">
													...
													<!--end::Time-->
													<!--begin::Title-->
													<a href="#" class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">Dashboard UI/UX Design
														Review</a>
													<!--end::Title-->
													<!--begin::User-->
													<div class="text-gray-400">Lead by
										...
										<div id="kt_schedule_day_1" class="tab-pane fade show active">
											...
											<div class="d-flex flex-stack position-relative mt-8">
												...
												<div class="fw-semibold ms-5 text-gray-600">
													...
													<!--end::Time-->
													<!--begin::Title-->
													<a href="#" class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">Team Backlog Grooming
														Session</a>
													<!--end::Title-->
													<!--begin::User-->
													<div class="text-gray-400">Lead by
										...
										<div id="kt_schedule_day_2" class="tab-pane fade show">
											...
											<div class="d-flex flex-stack position-relative mt-8">
												...
												<div class="fw-semibold ms-5 text-gray-600">
													...
													<!--end::Time-->
													<!--begin::Title-->
													<a href="#" class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">Marketing Campaign
														Discussion</a>
													<!--end::Title-->
													<!--begin::User-->
													<div class="text-gray-400">Lead by
										...
										<div id="kt_schedule_day_5" class="tab-pane fade show">
											...
											<div class="d-flex flex-stack position-relative mt-8">
												...
												<div class="fw-semibold ms-5 text-gray-600">
													...
													<!--end::Time-->
													<!--begin::Title-->
													<a href="#" class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">Lunch & Learn Catch
														Up</a>
													<!--end::Title-->
													<!--begin::User-->
													<div class="text-gray-400">Lead by
