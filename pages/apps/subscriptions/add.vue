					...
					<form class="form" action="#" id="kt_subscriptions_create_new">
						...
						<div class="card card-flush pt-3 mb-5 mb-lg-10">
							...
							<div class="card-body pt-0">
								...
								<div class="mb-7 d-none">
									...
									<NuxtLink to="/apps/customers/list" class="btn btn-light-primary">Add New Customer</NuxtLink>
								</div>
									...
									<table class="table align-middle table-row-dashed fs-6 fw-semibold gy-4"
										...
										<tbody class="text-gray-600">
											<tr>
												...
												<td class="text-end">
													<!--begin::Delete-->
													<a href="#" class="btn btn-icon btn-flex btn-active-light-primary w-30px h-30px me-3"
						...
						<div class="card card-flush pt-3 mb-5 mb-lg-10" data-kt-subscriptions-form="pricing">
							...
							<div class="card-header">
								...
								<!--begin::Card toolbar-->
								<div class="card-toolbar">
									<a href="#" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">New
										Method</a>
								</div>
								<!--end::Card toolbar-->
							</div>
												...
												<div class="flex-equal me-5">
													<table class="table table-flush fw-semibold gy-1">
														...
														<tr>
															...
															<td class="text-gray-800">**** 9965</td>
														</tr>
														<tr>
											...
											<div class="d-flex flex-wrap py-5">
												...
												<div class="flex-equal me-5">
													<table class="table table-flush fw-semibold gy-1">
														...
														<tr>
															<td class="text-muted min-w-125px w-125px">Number</td>
															<td class="text-gray-800">**** 3062</td>
														</tr>
														<tr>
															<td class="text-muted min-w-125px w-125px">Expires</td>
											...
											<div class="d-flex flex-wrap py-5">
												...
												<div class="flex-equal me-5">
													<table class="table table-flush fw-semibold gy-1">
														...
														<tr>
															<td class="text-muted min-w-125px w-125px">Number</td>
															<td class="text-gray-800">**** 4929</td>
														</tr>
														<tr>
															<td class="text-muted min-w-125px w-125px">Expires</td>
							...
							<div class="card-body pt-0">
								...
								<div class="d-flex flex-column mb-15 fv-row">
									...
									<div class="fs-5 fw-bold form-label mb-3">Custom fields
										<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover" data-bs-trigger="hover"
											data-bs-html="true" data-bs-content="Add custom fields to the billing invoice."></i>
									</div>
									<!--end::Label-->
									<!--begin::Table wrapper-->
									<div class="table-responsive">
									...
									<button type="button" class="btn btn-light-primary me-auto" id="kt_create_new_custom_fields_add">Add
										custom field</button>
								...
								<div class="d-flex flex-column mb-10 fv-row">
									...
									<div class="fs-5 fw-bold form-label mb-3">Invoice footer
										<i tabindex="0" class="cursor-pointer fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
											...
											data-bs-content="Add an addition invoice footer note."></i>
									</div>
									<!--end::Label-->
								...
								<div class="d-flex flex-column fv-row rounded-3 p-7 border border-dashed border-gray-300">
									...
									<div class="fs-5 fw-bold form-label mb-3">Pro-rate billing
										<i tabindex="0" class="cursor-pointer fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="popover"
											data-bs-trigger="hover focus" data-bs-html="true" data-bs-delay-hide="1000"
											data-bs-content="Pro-rated billing dynamically calculates the remainder amount leftover per billing cycle that is owed. &lt;a href='#'&gt;Learn more&lt;/a&gt;."></i>
									</div>
									<!--end::Label-->
									<!--begin::Checkbox-->
									<label class="form-check form-check-custom form-check-solid">
										<input class="form-check-input" type="checkbox" value="1" />
										<span class="form-check-label text-gray-600">Allow pro-rated billing when treshold usage is paid
											before end of billing cycle.</span>
									</label>
									<!--end::Checkbox-->
								</div>
								<!--end::Option-->
						...
						<div class="card-body pt-0 fs-6">
							...
							<div class="mb-7">
								...
								<div class="d-flex align-items-center mb-1">
									<!--begin::Name-->
									<NuxtLink to="/apps/customers/view"
										class="fw-bold text-gray-800 text-hover-primary me-2">Sean Bean</NuxtLink>
									<!--end::Name-->
									<!--begin::Status-->
							...
							<div class="mb-10">
								...
								<div class="mb-0">
									...
									<div class="fw-semibold text-gray-600 d-flex align-items-center">Mastercard
										<img src="/media/svg/card-logos/mastercard.svg" class="w-35px ms-2" alt="" />
									</div>
									<!--end::Card info-->
									<!--begin::Card expiry-->
								...
								<div class="py-5">
									...
									<div data-kt-search-element="suggestions">
										...
										<div class="text-center px-4 pt-10">
											<img src="/media/illustrations/sketchy-1/4.png" alt="" class="mw-100 mh-200px" />
										</div>
										<!--end::Illustration-->
									</div>
									<!--end::Suggestions-->
									...
									<div data-kt-search-element="empty" class="text-center d-none">
										...
										<div class="text-center px-4">
											<img src="/media/illustrations/sketchy-1/9.png" alt="user" class="mw-100 mh-200px" />
										</div>
										<!--end::Illustration-->
									</div>
									<!--end::Empty-->
								...
								<div class="scroll-y mh-300px me-n7 pe-7">
									...
									<div class="fv-row">
										...
										<label class="d-flex align-items-center mb-5">
											...
											<span class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="radio" name="product" checked="checked"
													data-kt-product-name="Basic" data-kt-product-price="15.99" data-kt-product-frequency="Month" />
											</span>
											<!--end::Radio-->
											<!--begin::Description-->
										...
										<label class="d-flex align-items-center mb-5">
											<!--begin::Radio-->
											<span class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="radio" name="product" data-kt-product-name="Basic Bundle"
													data-kt-product-price="149.99" data-kt-product-frequency="Year" />
											</span>
											<!--end::Radio-->
											<!--begin::Description-->
											<span class="d-flex flex-column me-3">
										...
										<label class="d-flex align-items-center mb-5">
											<!--begin::Radio-->
											<span class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="radio" name="product" data-kt-product-name="Teams"
													data-kt-product-price="20.99" data-kt-product-frequency="Month" />
											</span>
											<!--end::Radio-->
											<!--begin::Description-->
											<span class="d-flex flex-column me-3">
										...
										<label class="d-flex align-items-center mb-5">
											<!--begin::Radio-->
											<span class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="radio" name="product" data-kt-product-name="Teams Bundle"
													data-kt-product-price="199.99" data-kt-product-frequency="Year" />
											</span>
											<!--end::Radio-->
											<!--begin::Description-->
											<span class="d-flex flex-column me-3">
										...
										<label class="d-flex align-items-center mb-5">
											<!--begin::Radio-->
											<span class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="radio" name="product" data-kt-product-name="Corporate"
													data-kt-product-price="224.99" data-kt-product-frequency="Month" />
											</span>
											<!--end::Radio-->
											<!--begin::Description-->
											<span class="d-flex flex-column me-3">
										...
										<label class="d-flex align-items-center mb-5">
											<!--begin::Radio-->
											<span class="form-check form-check-custom form-check-solid me-5">
												<input class="form-check-input" type="radio" name="product" data-kt-product-name="Enterprise"
													data-kt-product-price="224.99" data-kt-product-frequency="Month" />
											</span>
											<!--end::Radio-->
											<!--begin::Description-->
