				...
				<div class="card-header border-0 pt-6">
					...
					<div class="card-toolbar">
						...
						<div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
								...
								<div class="px-7 py-5" data-kt-subscription-table-filter="form">
									...
									<div class="mb-10">
										...
										<select class="form-select form-select-solid fw-bold" data-kt-select2="true"
											data-placeholder="Select option" data-allow-clear="true" data-kt-subscription-table-filter="month"
									...
									<div class="mb-10">
										...
										<select class="form-select form-select-solid fw-bold" data-kt-select2="true"
											data-placeholder="Select option" data-allow-clear="true" data-kt-subscription-table-filter="status"
											data-hide-search="true">
											<option></option>
									...
									<div class="mb-10">
										...
										<select class="form-select form-select-solid fw-bold" data-kt-select2="true"
											data-placeholder="Select option" data-allow-clear="true" data-kt-subscription-table-filter="billing"
											data-hide-search="true">
											<option></option>
									...
									<div class="mb-10">
										...
										<select class="form-select form-select-solid fw-bold" data-kt-select2="true"
											data-placeholder="Select option" data-allow-clear="true" data-kt-subscription-table-filter="product"
											data-hide-search="true">
											<option></option>
							...
							<NuxtLink to="/apps/subscriptions/add" class="btn btn-primary">
								...
								<!--end::Svg Icon-->Add Subscription</NuxtLink>
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
						...
						<tbody class="text-gray-600 fw-semibold">
								...
								<td class="text-end">
									...
									<div
										...
										<div class="menu-item px-3">
											<NuxtLink to="/apps/subscriptions/add" class="menu-link px-3">View</NuxtLink>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-3">
											<NuxtLink to="/apps/subscriptions/add" class="menu-link px-3">Edit</NuxtLink>
										</div>
										<!--end::Menu item-->
										<!--begin::Menu item-->
										<div class="menu-item px-3">
							...
							<tr>
								...
								<!--begin::Customer=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Robert
										Doe</NuxtLink>
								</td>
								<!--end::Customer=-->
								<!--begin::Status=-->
							...
							<tr>
								...
								<!--begin::Customer=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">John
										Miller</NuxtLink>
								</td>
								<!--end::Customer=-->
								<!--begin::Status=-->
							...
							<tr>
								...
								<!--begin::Customer=-->
								<td>
									<NuxtLink to="/apps/customers/view" class="text-gray-800 text-hover-primary mb-1">Lucy
										Kunic</NuxtLink>
								</td>
								<!--end::Customer=-->
								<!--begin::Status=-->
