					...
					<div class="card card-flush pt-3 mb-5 mb-xl-10">
						...
						<div class="card-header">
							...
							<div class="card-toolbar">
								<NuxtLink to="/apps/subscriptions/add" class="btn btn-light-primary">Update Product</NuxtLink>
							</div>
							<!--end::Card toolbar-->
						</div>
						<!--end::Card header-->
										...
										<table class="table fs-6 fw-semibold gs-0 gy-2 gx-2 m-0">
											...
											<tr>
												...
												<td class="text-gray-800 min-w-200px">
													<NuxtLink to="/pages/apps/customers/view"
														class="text-gray-800 text-hover-primary">smith@kpmg.com</NuxtLink>
												</td>
											</tr>
											<!--end::Row-->
											<!--begin::Row-->
									...
									<tbody>
										...
										<tr>
											...
											<td class="min-w-400px">Invoice
												<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">5878-8295</a>status has changed
												from
										...
										<tr>
											<!--begin::Event=-->
											<td class="min-w-400px">Invoice
												<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">7686-4163</a>is
												<span class="badge badge-light-info">In Progress</span>
											</td>
											<!--end::Event=-->
											<!--begin::Timestamp=-->
											<td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2022, 5:30 pm</td>
											<!--end::Timestamp=-->
										</tr>
										<!--end::Table row-->
										<!--begin::Table row-->
										<tr>
											...
											<td class="min-w-400px">
												<a href="#" class="fw-bold text-gray-800 text-hover-primary me-1">Sean Bean</a>has made payment to
												<a href="#" class="fw-bold text-gray-800 text-hover-primary">8350-9518</a>
											</td>
											<!--end::Event=-->
											<!--begin::Timestamp=-->
										...
										<tr>
											...
											<td class="min-w-400px">
												...
												<a href="#" class="fw-bold text-gray-800 text-hover-primary">9147-2262</a>
											</td>
											<!--end::Event=-->
											<!--begin::Timestamp=-->
						...
						<div class="card-header">
							...
							<div class="card-toolbar">
								...
								<div
									...
									<!--begin::Menu item-->
									<div class="menu-item px-3">
										<a href="#" class="menu-link text-danger px-3" data-kt-subscriptions-view-action="edit">Cancel
											Subscription</a>
									</div>
									<!--end::Menu item-->
								</div>
						...
						<div class="card-body pt-0 fs-6">
							...
							<div class="mb-0">
								<NuxtLink to="/apps/subscriptions/add" class="btn btn-primary"
									id="kt_subscriptions_create_button">Edit Subscription</NuxtLink>
							</div>
							<!--end::Actions-->
						</div>
						<!--end::Card body-->
