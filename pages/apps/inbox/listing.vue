			...
			<div class="d-flex flex-column flex-lg-row">
				...
				<div class="d-none d-lg-flex flex-column flex-lg-row-auto w-100 w-lg-275px" data-kt-drawer="true"
					...
					<div class="card card-flush mb-0" data-kt-sticky="false" data-kt-sticky-name="inbox-aside-sticky"
						...
						<div class="card-body">
							<!--begin::Button-->
							<NuxtLink to="/apps/inbox/compose" class="btn btn-primary fw-bold w-100 mb-8">New
								Message</NuxtLink>
							<!--end::Button-->
							<!--begin::Menu-->
							<div
							...
							<table class="table table-hover table-row-dashed fs-6 gy-5 my-0" id="kt_inbox_listing">
								...
								<tbody>
									<tr>
										...
										<td class="min-w-80px">
											<!--begin::Star-->
											<a href="#" class="btn btn-icon btn-color-gray-400 btn-active-color-primary w-35px h-35px"
										...
										<td class="w-150px w-md-175px">
											<NuxtLink to="/apps/inbox/reply" class="d-flex align-items-center text-dark">
												<!--begin::Avatar-->
										...
										<td>
											<div class="text-dark mb-1">
												<!--begin::Heading-->
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													<span class="fw-bold">Digital PPV Customer Confirmation</span>
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Thank you for ordering UFC 240 Holloway vs Edgar
									...
									<tr>
										...
										<td class="w-150px w-md-175px">
											<NuxtLink to="/apps/inbox/reply" class="d-flex align-items-center text-dark">
												<!--begin::Avatar-->
												<div class="symbol symbol-35px me-3">
													<span class="symbol-label" style="background-image:url(/media/avatars/300-1.jpg)"></span>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Please make sure that you have one of the following
														cards with you when we deliver your order...</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
										</td>
									...
									<tr>
										...
										<td class="w-150px w-md-175px">
											<NuxtLink to="/apps/inbox/reply" class="d-flex align-items-center text-dark">
												<!--begin::Avatar-->
												<div class="symbol symbol-35px me-3">
													<span class="symbol-label" style="background-image:url(/media/avatars/300-5.jpg)"></span>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Your Order #224820998666029 has been placed on
														Saturday, 29 June</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
										</td>
									...
									<tr>
										...
										<td class="w-150px w-md-175px">
											<NuxtLink to="/apps/inbox/reply" class="d-flex align-items-center text-dark">
												<!--begin::Avatar-->
												<div class="symbol symbol-35px me-3">
													<span class="symbol-label" style="background-image:url(/media/avatars/300-25.jpg)"></span>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Your payment of 4500USD to AirCar has been authorized
														and confirmed, thank you your account. This...</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
											<!--begin::Badges-->
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Congratulations on your iRun Coach subscription. You
														made no space for excuses and you</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
										</td>
									...
									<tr>
										...
										<td class="w-150px w-md-175px">
											<NuxtLink to="/apps/inbox/reply" class="d-flex align-items-center text-dark">
												<!--begin::Avatar-->
												<div class="symbol symbol-35px me-3">
													<span class="symbol-label" style="background-image:url(/media/avatars/300-9.jpg)"></span>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Congratulations on your iRun Coach subscription. You
														made no space for excuses and you decided on a healthier and happier life...</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
										</td>
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Thank you for creating a LIPO Account. Please click
														the link below to activate your account.</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
											<!--begin::Badges-->
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">What you requested can't be arranged ahead of time
														but PalmLake said they'll do their best to accommodate you upon arrival....</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
										</td>
									...
									<tr>
										...
										<td class="w-150px w-md-175px">
											<NuxtLink to="/apps/inbox/reply" class="d-flex align-items-center text-dark">
												<!--begin::Avatar-->
												<div class="symbol symbol-35px me-3">
													<span class="symbol-label" style="background-image:url(/media/avatars/300-23.jpg)"></span>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Discover interesting ideas and unique perspectives.
														Read, explore and follow your interests. Get personalized recommendations delivered to
														you....</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
										...
										<td>
											<div class="text-dark mb-1">
												...
												<NuxtLink to="/apps/inbox/reply" class="text-dark">
													...
													<span class="fw-bold d-none d-md-inine">-</span>
													<span class="d-none d-md-inine text-muted">Video has rolled into every marketing platform or
														channel, leaving...</span>
												</NuxtLink>
												<!--end::Heading-->
											</div>
											<!--begin::Badges-->
									...
									<tr>
										...
										<td class="w-150px w-md-175px">
											<NuxtLink to="/apps/inbox/reply" class="d-flex align-items-center text-dark">
												<!--begin::Avatar-->
												<div class="symbol symbol-35px me-3">
													<span class="symbol-label" style="background-image:url(/media/avatars/300-12.jpg)"></span>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
									...
									<tr>
										...
										<td class="w-150px w-md-175px">
											<NuxtLink to="/apps/inbox/reply" class="d-flex align-items-center text-dark">
												<!--begin::Avatar-->
												<div class="symbol symbol-35px me-3">
													<span class="symbol-label" style="background-image:url(/media/avatars/300-13.jpg)"></span>
												</div>
												<!--end::Avatar-->
												<!--begin::Name-->
